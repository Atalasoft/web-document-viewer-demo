                            ...
                            try
                            {
                                ...
                                if (!referencedImage.IsAbsoluteUri)
                                {
                                    if (System.Web.HttpContext.Current != null)
                                        embeddedImage.Image = new AnnotationImage(new Atalasoft.Imaging.AtalaImage(System.Web.HttpContext.Current.Request.MapPath(((ReferencedImageData)layers[i].Items[j]).FileName)));
                                    else
                                        embeddedImage.Image = new AnnotationImage(new Atalasoft.Imaging.AtalaImage(((ReferencedImageData)layers[i].Items[j]).FileName));
                                }
