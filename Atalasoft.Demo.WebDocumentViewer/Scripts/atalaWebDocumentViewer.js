...
/**
     * @private
     */},{key:"Platform",get:function(){return this.platform}}]),o}(v),x=new v,vn=new b,y=x,bn={
 ...
 * @private
 */
function X(e,t,n){for(t||(t={x:0,y:0}),n||(n=e.target instanceof HTMLElement?e.target:null),vn.Explorer&&null===e&&(e=event),e instanceof MouseEvent?(t.x=e.clientX,t.y=e.clientY):(t.x=e.touches[0].clientX,t.y=e.touches[0].clientY);n&&!isNaN(n.offsetLeft)&&!isNaN(n.offsetTop);)t.x-=n.offsetLeft-n.scrollLeft,t.y-=n.offsetTop-n.scrollTop,n=n.offsetParent instanceof HTMLElement?n.offsetParent:null;return t}
/**
 * @private
 */function J(e,t,n){t||(t={x:0,y:0});var o=e.originalEvent;if(e.offsetX||e.offsetY)if(vn.Firefox){var i=e.target.raphaelParent?pn(e.target).parents("svg").offset():pn(e.target.offsetParent||e.target.parentNode).offset();t.y=i?(t.x=e.pageX-i.left,e.pageY-i.top):(t.x=e.pageX,e.pageY)}else if(void 0===o||o.currentTarget===o.target||n)t.x=e.offsetX,t.y=e.offsetY;else if(o.currentTarget.offsetLeft||o.currentTarget.offsetTop||!o.currentTarget.ownerSVGElement)t.x=o.currentTarget.offsetLeft+e.offsetX,t.y=o.currentTarget.offsetTop+e.offsetY;else{var a=vn.Explorer?o.currentTarget.ownerSVGElement.getBBox():o.currentTarget.getBBox();t.x=Math.round(a.x),t.y=Math.round(a.y)}else if(vn.Explorer)o instanceof MouseEvent?(t.x=o.x,t.y=o.y):(t.x=0,t.y=0);else{var r=null,l=e.target;o instanceof TouchEvent&&1===o.touches.length&&(l=document.elementFromPoint(o.touches[0].clientX,o.touches[0].clientY));var s=vn.Features.Touch&&o instanceof TouchEvent?o.touches[0]:null,c=pn(l),u={pageX:0,pageY:0};null!==s?(u.pageX=s.pageX,u.pageY=s.pageY):o instanceof MouseEvent&&(u.pageX=o.pageX,u.pageY=o.pageY),u.pageX||u.pageY||(u.pageX=e.pageX,u.pageY=e.pageY),e.target.raphael?r=c.parents("div:eq(0)").offset():(e.target.raphaelParent||0<c.parents("svg").length)&&(r=c.parents("svg").parents("div:eq(0)").offset()),r||(r=c.offset()),t.y=r?(t.x=u.pageX-r.left,u.pageY-r.top):(t.x=u.pageX,u.pageY)}return t}
/**
...
/**
   ...
   */
function(){if(vn.Explorer){var e=parseInt(vn.Version,10);10<=e&&e<12&&d.node&&d.node.parentNode&&d.node.parentNode.insertBefore(d.node,d.node)}}()}}a.commitTransform=function(){var e,t,n;pn.extend(u,(e=p,t=r.getZoom(h._pageindex),{x:(n=e.split()).dx/t,y:n.dy/t,width:n.scalex/t,height:n.scaley/t})),d.transform(E()),M(),L=null},a.transformUI=function(e,t,n,o){p=mn.matrix(n,0,0,o,e,t),L||(L=function(e,t){var n;if(e.points&&1<e.points.length){var o=h.getBox();(n=mn.matrix(1,0,0,1,0,0)).scale(1/o.width,1/o.height,0,0),n.translate(-o.x,-o.y)}else(n=mn.matrix(t,0,0,t,0,0)).translate(e.x,e.y),n.scale(e.width,e.height,0,0);return n}(u,1)),p.add(L.a,L.b,L.c,L.d,L.e,L.f),d.transform(p.toTransformString()),s&&s.repaint()};var L=null;function H(e,t,n){return t>=e.x&&t<=e.x+e.width&&n>=e.y&&n<=e.y+e.height}},Oe=function(e,t,n){var i=e,a=n,r=this,o=new q(r),l=null,s=null,c=null,u=null,d=null,h=null,f=null,g=null,p=t.multiview?t:{
/**
 ...
 */var An=function e(t,n,o){var i=this,a=this,d=t,x=n,c=new Ve(d),r={
...
/**
       ...
       * @function
       */
insertLayer:function(e,t,n,o){n=T(e,t,n),"function"==typeof o&&o(),d.trigger({type:w.layerinserted,srcurl:e,srcindex:t,index:n}),d.trigger(w.layerschanged)},
/**
       ...
       * @function
       */
removeLayer:function(e,t){var n=C(e);"function"==typeof t&&t(),d.trigger({type:w.layerremoved,layer:n,index:e}),d.trigger(w.layerschanged)},
/**
       ...
       * @function
       */
moveLayer:function(e,t,n){t=M(e,t),"function"==typeof n&&n(),d.trigger({type:w.layermoved,srcindex:e,destindex:t}),d.trigger(w.layerschanged)},
/**
...
/**
       ...
       * @function
       */
saveAll:function(e,t){ie(pn.extend(!0,{},{atala_annossavemode:1,atala_xmpfilename:e||"",atala_annos:ke()}),t),v.annoIdsCreated.length=0,v.annoIdsModified.length=0,v.annoIdsRemoved.length=0},
/**
       ...
       * @function
       */
save:function(e,t,n,o){var i=n?t+n-1:t;ie(pn.extend(!0,{},{atala_annossavemode:2,atala_xmpfilename:e||"",atala_annosstartindex:t,atala_annosendindex:i,atala_annos:ke(t,i)}),o);for(var a=t;a<=i;a++)if(v.annos.hasOwnProperty(a)&&v.annos[a])for(var r=v.annos[a].length,l=0;l<r;l++)if(v.annos[a][l]){var s=v.annos[a][l].get();s&&se(s.annotationId)}},
/**
       ...
       * @function
       */
saveSingle:function(e,t,n){var o=-1;if(0<=v.annoIdsCreated.indexOf(t)?o=1:0<=v.annoIdsModified.indexOf(t)?o=2:0<=v.annoIdsRemoved.indexOf(t)&&(o=3),-1===o){var i=!1;if(v.annos)for(var a=v.annos.length,r=0;r<a;r++){if(v.annos[r])for(var l=v.annos[r].length,s=0;s<l;s++){var c=v.annos[r][s].getClonedData();if(c&&c.annotationId===t){i=!0;break}}if(i)break}if(!i)return;o=2}var u="";if(3===o)u='{"annotationId":'+t+"}";else{var d=H(t);u=JSON.stringify(Pe(d,d.get().fIndex))}ie(pn.extend(!0,{},{atala_annossavemode:3,atala_xmpfilename:e||"",atala_annochangestatus:o,atala_annos:u}),n),se(t)},
/**
...
/**
       ...
       * @function
       */
showAnnotationsPropertiesWindow:function(){v.activeanno&&U()},
/**
...
/**
     ...
     */
setStamps:$};if(e.__exposedApi=r.annotations,!t)return null;var l=n._config,s=n._pages,u=!1,h=null,f=null,g=null,p=null,m=null,v={annos:[],activepage:null,activeanno:null,readonly:!!o,zoom:d.getZoom(),getZoom:x.getPageScale,getViewerTransform:x.getViewerTransform,getPageRotation:x.getPageRotation,annoIdsCreated:[],annoIdsModified:[],annoIdsRemoved:[],maxAnnotationId:0},b={},y=!1,_=!1,w={click:"annotationclicked",dblclick:"annotationdoubleclicked",touchstart:"annotationtouchstart",interactend:"annotationtouchend",touchmove:"annotationtouchmove",pinchmove:"annotationpinchresize",rightclick:"annotationrightclicked",mousedown:"annotationmousedown",mousedownleft:"annotationmousedownleft",mousedownright:"annotationmousedownright",mousemove:"annotationmousemove",mouseout:"annotationmouseout",mouseup:"annotationmouseup",mouseover:"annotationmouseover",annocreate:"annotationcreated",annoload:"annotationloaded",moved:"annotationmoved",rotated:"annotationrotated",annoresized:"annotationresized",repaint:"annotationrepainted",layerinserted:"layerinserted",layerremoved:"layerremoved",layermoved:"layermoved",layerschanged:"layerschanged",annotationchanged:"annotationchanged",annotationtextchanged:"annotationtextchanged",annotationspropertieswindowopened:"annotationspropertieswindowopened",annotationselected:"annotationselected",annotationdeselected:"annotationdeselected"};function z(){u=!0,v.readonly||(f=B(g),p=new Le(n._config.parent),null!=l.annotations.defaults&&K(l.annotations.defaults),null!=l.annotations.stamps&&$(l.annotations.stamps),null!=l.annotations.images&&ee(l.annotations.images),null!=l.annotations.custom&&te(l.annotations.custom))}
/**
   * [Internal] Disposes memory intensive objects
   * @returns undefined
   */function k(e){m.translate(e.dx,e.dy)}function P(e){v.zoom=e.zoom}function T(e,t,n){e||"number"!=typeof t||(t=C(t)),t=t||[],null==n?n=v.annos.length:n<0&&(n=0);for(var o=v.annos.length,i=0;i<t.length;i++)Z(t[i],n,null);if(o<n)for(var a=o;a<v.annos.length;++a)v.annos[a]||(v.annos[a]=[]);for(var r=v.annos[n].length,l=0;l<r;l++){var s=v.annos[n][l].get().annotationId;s&&0!==s&&!de(s)||(s=le()+1,v.annos[n][l].setAnnotationId(s)),v.maxAnnotationId<s&&(v.maxAnnotationId=s),v.annos[n][l].setFIndex(n),ce(s)}return D(),n}function D(){if(v.annos){for(var e=1/0,t=v.annos.length,n=0;n<t;n++)if(v.annos[n])for(var o=v.annos[n].length,i=0;i<o;i++){var a=v.annos[n][i].get().annotationId;a<e&&(e=a)}if(e!==1/0&&1<e)for(var r=v.maxAnnotationId=0;r<t;r++)if(v.annos[r])for(var l=v.annos[r].length,s=0;s<l;s++){var c=v.annos[r][s].get().annotationId,u=c-e+1;v.annos[r][s].setAnnotationId(u),v.maxAnnotationId<u&&(v.maxAnnotationId=u);var d=v.annoIdsCreated.indexOf(c);-1<d&&(v.annoIdsCreated[d]=u),-1<(d=v.annoIdsModified.indexOf(c))&&(v.annoIdsModified[d]=u),-1<(d=v.annoIdsRemoved.indexOf(c))&&(v.annoIdsRemoved[d]=u)}}}function C(e){if(v.annos&&e<v.annos.length){if(v.annos[e])for(var t=v.annos[e].length,n=0;n<t;n++){var o=v.annos[e][n].get();o&&ue(o.annotationId)}for(var i=pn.extend(!0,{},v.annos[e]),a=v.annos[e].length-1;0<=a;a--)Y(a,e);return i}return null}function M(e,t){return T(null,C(e),t)}function E(e){e&&e.remove&&!e.grip&&e.paper&&e.paper._trash&&e.paper._trash.push(e)}function S(e){I(e.index,e.page)}function I(e,t){if(e<v.annos.length&&(F(t),v.annos[e]&&v.annos[e].length))for(var n,o=0;o<v.annos[e].length;o++)(n=v.annos[e][o])._pageindex=e,n.repaint(t._paper),n.get("selected")&&c.select(n,e,!0)}function F(e){e._grips.clear(),e._paper._annos.remove(),e._paper._annos.clear(),e._paper.forEach(function(e){e&&e.remove&&!e.grip&&e.paper&&e.paper._trash&&e.paper._trash.push(e)}),e._paper._trash.remove(),e._paper._trash.clear(),xe()}function A(e){v.activepage=e}function O(e){e.page._paper&&(F(e.page),e.page.append(e.page._paper.canvas))}function V(e){L(e.page)}function L(e){if(e&&0<=e._index&&v.annos[e._index]){for(var t=0;t<v.annos[e._index].length;t++)v.annos[e._index][t].repaint();e&&e._grips.repaint()}}function H(e){for(var t=v.annos.length,n=0;n<t;n++)if(v.annos[n])for(var o=v.annos[n].length,i=0;i<o;i++){var a=v.annos[n][i].get();if(a&&a.annotationId===e)return v.annos[n][i]}return null}function R(e){f&&(f.visible&&j(),f.remove());var t=pn.extend(!0,{},g);if(d.trigger("contextmenu",[v.activeanno.getClonedData(),t]),pn.isEmptyObject(t))f=null;else{for(var n in t)t.hasOwnProperty(n)&&(t[n]=N(t[n]));f=B(t)}!function(e){if(f){var t=Fn.GetAnnotationLocalizedString("menuPropertiesButton"),n=Fn.GetAnnotationLocalizedString("menuDeleteButton");if(v.activeanno.get("readonly"))f.children(":contains("+t+")").off("click").children("a, div").css("color","#cdc9c9"),f.children(":contains("+n+")").off("click").children("a, div").css("color","#cdc9c9");else{var o=f.children(":contains("+t+")");void 0!==o.data("events")&&"click"in o.data("events")||o.on("click",U),o.children("a").css("color","#000000")}0===f.closest().length&&h.prepend(f);var i={x:e.x-6,y:e.y-6};f.css({left:i.x,top:i.y}),f.show(),f.visible=!0}}(e)}function j(){f&&(f.hide(),f.visible=!1)}function B(e){var t=x.createMenu(e);return t.css({position:"fixed","z-index":99999}),t.mouseleave(j),t.visible=!1,t}function N(e){return function(){return j(),e.call(this,v.activeanno.getClonedData())}}function q(){var e=v.activepage?v.activepage._index:0;if(v.annos[e]){var t=pn.inArray(v.activeanno,v.annos[e]);-1!==t&&(v.activeanno=null,Y(t,e))}j()}function U(){d.trigger({type:"annotationspropertieswindowopened",annotation:v.activeanno}),j(),p.show(v.activeanno)}
/**
   * Clears the annotations and related data from all pages
   */
function W(){var e=v.annos.length;if(0<e){for(var t=0;t<e;t++)if(v.annos[t])for(var n=v.annos[t].length,o=0;o<n;o++){var i=v.annos[t][o].get();i&&ue(i.annotationId)}if(v.annos.length=0,s)for(var a=0;a<s.length;a++)s[a]._grips.clear(),s[a]._paper.forEach(E),s[a]._paper._trash.remove(),s[a]._paper._trash.clear(),s[a]._paper._annos.remove(),s[a]._paper._annos.clear();d.trigger({type:"annotationscleared"})}}
/**
   * Creates an annotation on the desired page with the given annotation data.
   ...
   */function Z(e,t,n){var o={};e.multiview?o=e:(e&&e.type&&b[e.type]&&pn.extend(!0,o,b[e.type]),pn.extend(!0,o,e));var i=new Oe(d,o,v);i._pageindex=t,i.setFIndex(t);var a=i.get().annotationId;return a&&0!==a&&!de(a)||(a=le()+1,i.setAnnotationId(a)),v.maxAnnotationId<a&&(v.maxAnnotationId=a),void 0===v.annos[t]&&(v.annos[t]=[]),v.annos[t].push(i),ce(a),x.redrawPageFromIndex(t,!0),"function"==typeof n&&n(i),_e(i),d.trigger({type:w.annocreate,anno:i,annotation:i,page:t}),i}function X(e,t,n){return Z(e,t,n).getClonedData()}function G(e,t){Y(t,e)}
/**
   ...
   */function Y(e,t){var n=v.annos[t].splice(e,1)[0],o=n.get();o&&ue(o.annotationId),v.activepage&&v.activepage._paper&&v.activepage._paper._annos.exclude(n.getObject()),v.activeanno===n&&(v.activeanno=null),n.dispose(),v.activepage&&v.activepage._grips&&v.activepage._grips.repaint(),d.trigger({type:"annotationdeleted",page:t,index:e})}function J(e){var n=this,t=[];if(0===v.annos.length||void 0===v.annos[e])return t;for(var o=0;o<v.annos[e].length;o++)t[o]=v.annos[e][o].getClonedData();return t.sort(function(e,t){return Re(this,n),e.tabindex-t.tabindex}.bind(this))}function Q(e,t){if(isFinite(t)){if(t<v.annos.length)for(var n=0;n<v.annos[t].length;++n)if(v.annos[t][n].isCloneSource(e))return v.annos[t][n]}else for(var o=0;o<v.annos.length;++o){var i=Q(e,o);if(i)return i}return null}function K(e){l.annotations.defaults=e;for(var t=0;t<e.length;t++)"string"==typeof e[t].type&&(b[e[t].type]=e[t]);return d}function $(e){l.annotations.stamps=e;for(var t=0;t<e.length;t++)Ie(e[t]);if(u){var n={type:"button",id:x._id+"_toolbar_Button_Stamp",icon:"stamp",tooltip:"Draw Stamp",text:""},o=x.createDropDownButton(n);n.onclick=x.drawAnnotation,x.createDropDownMenu(o,n,e)}return d}function ee(e){l.annotations.images=e;for(var t=0;t<e.length;t++)e[t].type="image";if(u){var n={type:"button",id:x._id+"_toolbar_Button_Image",icon:"image",tooltip:"Draw Image",text:""},o=x.createDropDownButton(n);n.onclick=x.drawAnnotation,x.createDropDownMenu(o,n,e)}return d}
/**
 ...
 * @inner
 * @memberOf Atalasoft.Controls.WebDocumentViewer
 */var Ln=function e(i,t,n){var o=this,p=i,m=t,v=n,a={document:{events:{
/**
...
/**
       ...
       * @function
       */
getPageText:function(i,a,e){var r=this,l=pn.Deferred();return me(i).done(function(){We(this,r);var e="",t=I(i);if(t)for(var n=0;n<t.regions.length;n++){var o=Z(t.regions[n]);o&&(e+=o)}l.resolve(e),a&&"function"==typeof a&&a(e)}.bind(this)).fail(function(){We(this,r),l.reject(),e&&"function"==typeof e&&e()}.bind(this)),l.promise()},
/**
...
/**
   ...
   */function de(c,o){var u,d=3,h=c.start,f=c.end,g=c.active,p=-1,m=-1,v=0,b=this,x=[],t=[],y=T(-1);function i(e){t.push({action:_,args:[!0,P(e)]}),n()}
/**
     ...
     */function n(){if(!u&&t.length){var e=t.shift();e&&"function"==typeof e.action&&e.action.apply(b,e.args)}}function _(n,o){if(w()){var e=n?1:-1,t=I(p);if(t&&t.searchResult&&t.searchResult.length&&(n?-1<=m&&m<v-1:0<m&&m<=v)){m+=e;var i=t.searchResult[m];y=T(p,i),X(p,i);var a=t?t.rotation:0,r=C.getViewerTransform(p,a),l=te(i.bounds,t.regions[i.region]),s=Re(r.x(l.x,l.y),r.y(l.x,l.y));C.showPagePoint(p,s,_n.Center,function(){o(b,T(p,i))})}else u=u||z(c.text,0<=p?p+e:g,n).done(function(e,t){w()?0<=e&&t&&(p=e,v=t.searchResult.length,m=n?-1:v,_(n,o)):o(b,null)}).fail(function(){o(b,null)})}else o(b,null)}
/**
...
/**
       ...
       * @type {boolean}
       */
b.wrap=!0,M.on("pagetextloaded",e),D.bind({pageshown:r}),setTimeout(function(){for(var e=0;e<E.length;e++){var t=E[e]._index;if(!(t<h||f<t)){var n=I(t);n&&!n.loading&&(n.searchResult=k(n,c.text),n.searchResult.length&&(F(t,E[e]),t===g&&(v=n.searchResult.length,p=g)))}}i(o)},0),
/**
...
/**
     ...
     */,b.getCurrentLineText=function(){if(w()&&y&&0<=y.page){var e=I(y.page);if(e&&e.regions[y.region]&&e.regions[y.region].lines[y.line])return W(e.regions[y.region].lines[y.line])}return null},
/**
...
/**
     ...
     * */
multiprocessing:!1};if(t){var f=t.mousetool;t.mousetool&&"object"!=typeof t.mousetool&&(t.mousetool=pn.extend({},W.mousetool,{type:f})),!t.tabular||t.direction!==xn.Horizontal&&1!==t.columns||(t.tabular=!1),pn.extend(!0,W,t),t.mousetool=f,t.localization&&Fn.SetLocalizationStrings(t.localization)}if(function(){x?(W.direction=xn.Vertical,W.tabular=!1):W.direction=W.direction===xn.Vertical||W.direction===xn.Horizontal?W.direction:xn.Vertical;W.fitting=W.fitting===yn.None||W.fitting===yn.Best||W.fitting===yn.Width||W.fitting===yn.Height?W.fitting:yn.Width,W.pageborderwidth=De(W.pageborderwidth)?parseInt(W.pageborderwidth,10):1,W.pagespacing=De(W.pagespacing)?parseInt(W.pagespacing,10):4,W.showpageborder=!!W.showpageborder,W.showpagenumber=!!W.showpagenumber,W.showstatus=!!W.showstatus,W.zoom=De(W.zoom,!0)?parseFloat(W.zoom):1,h=!1,W.scripturl=(e=W.scripturl,0<e.length&&-1===e.indexOf("/",e.length-1)&&-1===e.indexOf("\\",e.length-1)?W.scripturl+"/":W.scripturl),W.maxpagebuffersize=0<W.maxpagebuffersize&&W.pagebuffersize<W.maxpagebuffersize?W.maxpagebuffersize:0<W.pagebuffersize?W.pagebuffersize+10:50,function(){if((W.mousetool.type===bn.ZoomArea||W.mousetool.type===bn.Selection||W.mousetool.type===bn.Text)&&!W.showselecttools){if(null!==t.showselecttools&&void 0!==t.showselecttools)throw"The mouse tool type is incompatible with 'showselecttools' flag value.Please change the tool type or enable selection tools.";W.showselecttools=!0}}(),function(){W.upload||(W.upload={enabled:!1});var e=W.upload;!1!==e.enabled&&(e.allowedmaxfilesize=Cn(e.allowedmaxfilesize)?e.allowedmaxfilesize:Number.MAX_VALUE,e.allowdragdrop=!!e.allowdragdrop,e.allowmultiplefiles=!!e.allowmultiplefiles,e.allowedfiletypes="string"==typeof e.allowedfiletypes?e.allowedfiletypes:"",e.uploadpath="string"==typeof e.uploadpath?e.uploadpath:".",e.filesuploadconcurrency=Cn(e.filesuploadconcurrency)?e.filesuploadconcurrency:1,e.closeuiafterupload=!1!==e.closeuiafterupload)}();var e}(),e=W.allowannotations,n=W.allowtext,!Pn({checkjQueryOnly:!1,checkRaphael:e||n,checkClipboard:n}))return null;function g(){var e=N.memory.deallocateOldestEntry();!function(e){try{e.parentNode&&e.parentNode.removeChild(e),i.appendChild(e),i.innerHTML=""}catch(e){}}(e[0]),0<=e._cacheIndex&&(B.loadedImgs[e._cacheIndex]=null,e._cacheIndex=-1),e.remove(),e.length=0,e=null}function p(e){U.newpagedivsize={height:e.height,width:e.width},U.newpagedivfullzoom=e.fullzoom,W.minwidth=e.minwidth,W.zoom=e.fullzoom,Ht()}function m(e){var t=!1;if((q.smallest.width<=0||e.width<q.smallest.width)&&(q.smallest.width=e.width,t=!0),(q.smallest.height<=0||e.height<q.smallest.height)&&(q.smallest.height=e.height,t=!0),!L){if(x)Se(e.dx,e.dy);else{var n=U.scrollTarget.Page-1;if(e.index<=n)if(W.direction===xn.Vertical&&0<Math.abs(e.dy)){var o=ge(B.pageDivs[0]._index).height;B.edges[0].height(o),He(B.pageDivs[0]._index,null),Ce(null,ge(n).height+U.scrollTarget.dy,!1)}else if(W.direction===xn.Horizontal&&1<Math.abs(e.dx)){var i=ge(B.pageDivs[0]._index).width;B.edges[0].width(i),He(B.pageDivs[0]._index,null),Le(),Ce(ge(n).width+U.scrollTarget.dy,null,!1)}Se(e.dx,e.dy),fe();var a=B.scroller[0].scrollLeft,r=B.scroller[0].scrollTop;if(!B.scroller.propagationPaused()&&B.scrollH&&B.scrollV){var l=Math.round(a/B.scrollH._ratio),s=Math.round(r/B.scrollV._ratio);l!==B.scrollH.scrollLeft()&&(B.scrollH.pauseEventPropagation(!0),B.scrollH.scrollLeft(l)),s!==B.scrollV.scrollTop()&&(B.scrollV.pauseEventPropagation(!0),B.scrollV.scrollTop(s))}}t&&ne(ie())>B.pageDivs.length&&Ht()}}function v(e,t,n,o){var i=t.getPageSize(e.index,y);if(!i){var a=t.getPageFitMultiplier(e.index,y),r=a,l={width:e.width,height:e.height};1===r&&W.forcepagefit&&(l.width!==n.width||l.height!==n.height)&&0<l.width&&0<l.height&&(r=l.width/n.width>l.height/n.height?n.width/l.width:n.height/l.height,t.setPageFitMultiplier(e.index,r,y)),t.setPageSize(e.index,pn.extend({},l),y),o&&(l.width*=W.zoom*r,l.height*=W.zoom*r,(i=pn.extend({},q.size)).width*=W.zoom*a,i.height*=W.zoom*a,e.dx=l.width-i.width,e.dy=l.height-i.height,m(e))}}function b(){vn.Mobile.Any()?window.addEventListener("orientationchange",ut):window.addEventListener("resize",ut),B.scroller.scroll(Oe),Q(q.buffer)}function w(e){var t=e.target||e.srcElement;return("TEXTAREA"===t.nodeName||"INPUT"===t.nodeName||"text"===t.type)&&(!(t.attributes.selectable&&"false"===t.attributes.selectable.value||t.attributes.hasOwnProperty("readonly")&&"true"===t.attributes.readonly.value)&&void 0)}function z(t,n){return function(e){try{e.currentTarget=n&&0<n.length?n[0]:e.currentTarget,t&&t(e)}catch(e){Pe(e.message)}}}function Z(e,t){if(W.showerrors)throw void 0===t?e:e+": "+t;Pe(e+": "+t),cn({type:"error",name:e,message:t})}function k(e){Z(e.name,e.msg)}function P(e,t,n,o){var i=pn("<"+e+"></"+e+">");return t&&t.append&&i.appendTo(t),n&&i.attr("id",n),o&&i.html(o),i}function X(e,t,n){return P("div",e,t,n)}function T(e){var t=pn('<div div class="atala_draw_layer"></div>');return t.toFront=function(){t.css({"z-index":"10"}),t.reflow&&t.reflow()},t.reset=function(){t.css({"z-index":""}),t.reflow&&t.reflow()},e&&e.prepend(t),t}function D(e){var t=X(e.parent),n=y+"_toolbar";t.buttons=[];for(var o=0;e.children&&o<e.children.length;o++){var i=null;switch(e.children[o].type){case"button":if(vn.Features.Touch&&("lines"===e.children[o].icon||"polygon"===e.children[o].icon))continue;e.children[o].id=n+"_"+e.children[o].id,(i=A(e.children[o],t)).addClass(zn.atala_toolbar_button),t.buttons.push(i);break;case"pagelabel":B.pageLabel=P("span",t,n+"_"+e.children[o].id),(i=B.pageLabel).addClass("ui-controlgroup-item")}i&&e.children[o].cls&&i.addClass(e.children[o].cls)}return t}function C(e){var t=pn("<ul/>");for(var n in t.css({fontSize:"medium"}),t.addClass(zn.atala_context_menu),e)if(e.hasOwnProperty(n)){var o=pn('<li><div href="#"> '+n+" </div></li>");vn.Features.Touch&&o.on({touchend:e[n]}),o.click(e[n]),o.appendTo(t)}return t.menu(),t}function M(e,t,n){var o=pn('<div title="'+t+'" />');return n&&o.append(n),o.dialog(),o}function E(e){var t=P("span",B.toolbar.annoToolbar).addClass("ui-controlgroup-item");return A(e,t),F(t,e.id+"_Drop","ui-icon-triangle-1-s","Click To Choose",null,function(){var e=pn(this).next();if(e.is(":visible"))return e.hide(),!1;var t=e.prev().prev().parent();return e.menu().show().css({position:"absolute",top:0,left:0,"min-width":t.width()+"px","z-index":11}).position({my:"left top",at:"left bottom",of:t}),!1}),t.controlgroup(),B.toolbar.annoToolbar.controlgroup("refresh"),t}function S(e,t,n){for(var o=pn(e.children().first()),i={},a=0;a<n.length;a++)i[n[a].name]=I(o,t,n[a]);o.menu=C(i),e.append(o.menu),o.menu.hide()}function I(e,t,n){var o=function(){return e.button("option","label","Draw "+n.name),e.data("_annoConfig",n),e.click(t.onclick),e.menu.hide(),e.trigger("click"),!1};return ln("menuselect"+t.icon+n.name,z(o,e)),o}function F(e,t,n,o,i,a){var r=pn('<button id="'+t+'" title="'+o+'">'+(i||o)+"</button>");return a&&r.click(a),r.button({icon:n,showLabel:null!=i&&W.showbuttontext}),r.addClass("atala-ui-button"),e&&r.appendTo(e),r}function A(e,t){var n,o="menuclick"+(e.custom?e.id:e.icon),i=F(t,e.id,e.custom?e.icon:_+" "+_+"-"+e.icon,e.tooltip,e.text,(n=o,function(e){e.preventDefault(),cn(n,arguments)}));return i.data("_config",e),ln(o,z(e.onclick,i)),i}function O(e){var t,n,o={clearable:"atala_search_input_clearable",onclear:"atala_search_input_clear_hover",inputEmpty:"atala_search_input_empty",loading:"atala_search_input_loading"},i=e.parent||B.toolbar,a=null,r=null;function l(){var e=n.val();return e?n.addClass(o.clearable):n.removeClass(o.clearable),!!(e&&a&&a.isValid()&&e===a.getQuery())||(clearTimeout(r),a=null,e&&3<=e.length?(p(!0),r=setTimeout(function(){a=N.text.search(e,rn(),f),g(!0)},W.mousetool.text.searchdelay),!1):void h())}function s(e){var t=n.val();return 13===e.keyCode&&a&&t&&a.isValid()&&a.getQuery()===t?(e.shiftKey?u():c(),!1):13!==e.keyCode||a&&a.isValid()?27===e.keyCode?(d(),!1):void 0:(l(),!1)}function c(){a&&(g(!0),a.next(f))}function u(){a&&(g(!0),a.prev(f))}function d(){h(),x()}function h(){a=null,N.text.search(""),N.text.clearSelection(),g(!1),p(!0)}function f(e,t){e.isValid()&&(g(!1),e.wrap=W.mousetool.text.wrapsearch,t||p(t))}function g(e){v(o.loading,e)}function p(e){v(o.inputEmpty,!e)}function m(t){return function(e){e.preventDefault(),t&&t()}}function v(e,t){t?n.addClass(e):n.removeClass(e)}function b(e){v(o.onclear,this.offsetWidth-18<e.clientX-this.getBoundingClientRect().left)}function x(e){e&&e.preventDefault(),n.removeClass(o.clearable).removeClass(o.onclear).val("").change(),l()}!function(){t=X().addClass(zn.atala_search_container).addClass("ui-controlgroup-item"),(n=pn('<input type="text" placeholder="Search..." />').addClass(zn.atala_search_input).addClass("ui-widget")).on({keydown:s,"input propertychange":l}),P("span",t).css({width:"100%"}).append(n);var e=P("span",t);F(e,y+"_toolbar_search_button_next",_+" "+_+"-search-next","Next",null,m(c)).addClass(zn.atala_search_next).addClass(zn.atala_toolbar_button),F(e,y+"_toolbar_search_button_prev",_+" "+_+"-search-prev","Previous",null,m(u)).addClass(zn.atala_search_prev).addClass(zn.atala_toolbar_button),t.on("mousemove","."+o.clearable,b).on("touchstart click","."+o.onclear,x),i.append(t),i.append(pn("<div/>").css("clear","both"))}(),this.dispose=function(){n.off({keypress:s,"input propertychange":l}),t.off("mousemove","."+o.clearable,b).off("touchstart click","."+o.onclear,x),a&&a.dispose();t.remove()},this.ClearSearch=d}function V(){W.allowannotations&&c.annotations.cancelDraw(),N.mouseTool.setTool(bn.ZoomArea)}function G(o){return function(){var t=this,e=Y(q),i=e[0],n=[];e.forEach(function(e){return Bn(this,t),n.push(N.document.getPageRotation(e)+o)}.bind(this)),N.document.rotatePages(e,n,function(){var e=Pt(i),t=xe(i),n=W.direction===xn.Vertical?t.height*e:0;lt(W.pageselectlocation,_n.Center)||lt(W.pageselectlocation,_n.MiddleLeft)?n/=2:lt(W.pageselectlocation,_n.TopLeft)&&(n=0);var o={x:W.direction===xn.Vertical?0:n,y:W.direction===xn.Vertical?n:0};rt(i,o,W.pageselectlocation,!0)})}}!function(){var e=W.parent.attr("id")+"_wdv";++Mn.instanceCounter;for(;document.getElementById(e+Mn.instanceCounter);)++Mn.instanceCounter;y=e+Mn.instanceCounter}(),
/**
...
c.domclasses=zn,
/** WARNING: Changing values from these references can cause instability.*/
c.domattributes=kn;var Y=function(e){return[e.number-1]};function J(e,t){var n=X(e,t);return W.direction===xn.Vertical?(n.height(1),n.css({display:"block"})):W.direction===xn.Horizontal&&(n.width(1),n.css({display:"inline-block",overflow:"hidden"})),n._zoom=1,W.backcolor&&n.css({backgroundColor:W.backcolor}),n}function Q(e){if(void 0===e){var t=ne(L&&U.newpagedivsize&&0<W.zoom&&isFinite(W.zoom)?W.zoom:ie());t>W.maxpagebuffersize&&(t=W.maxpagebuffersize),q.buffer<t&&(q.buffer=t),q.buffer=Math.min(q.buffer,N.document.getPageCount()),e=q.buffer}function n(t){return function(){var e;e=t,U.activepage=e}}if(B.pageDivs.length<e)for(var o=B.pageDivs.length;o<e;o++)B.pageDivs[o]=X(),B.pageDivs[o].addClass(zn.atala_page_div),W.showselecttools&&(B.pageDivs[o]._rubberband=new jn(c,{},B.pageDivs[o],{getViewportSize:_e,getMaxZoom:ae,getPageOffsets:ge,raiseDrawLayer:It,resetDrawLayer:Ft})),B.pageDivs[o].on({touchstart:n(B.pageDivs[o]),mousedown:n(B.pageDivs[o])}),B.pageDivs[o].attr("tabindex",0),N.annotations&&N.annotations.addDrawingSurface(B.pageDivs[o]),(W.showselecttools||W.allowannotations||W.allowforms||W.allowtext)&&(B.pageDivs[o]._draw=T(B.pageDivs[o])),N.forms&&!L&&N.forms.addFormLayer(B.pageDivs[o]),N.text&&!L&&N.text.addTextLayer(B.pageDivs[o]);else if(B.pageDivs.length>e)for(;B.pageDivs.length>e&&0!==B.pageDivs.length;){var i=B.pageDivs.pop();i._rubberband&&i._rubberband.dispose(),N.annotations&&N.annotations.removeDrawingSurface(i),N.forms&&!L&&N.forms.removeFormLayer(i),N.text&&!L&&N.text.removeTextLayer(i),i&&Ge(i),i=null}}function K(e,P,t,n){"function"==typeof t&&(n=t,t=void 0);var T,o="function"==typeof n?[n]:[];T=pn(new Image);var i=.9,r=pn.extend(!0,{atala_cb:void 0},t||{});T._domEl=X(),T._domEl.addClass(zn.atala_page_image_anchor),T.addClass(zn.atala_page_image),T._domEl.append(T);var a={load:p,error:function(){k(),Z("ImageError","Image at frameIndex "+c()+" failed to load.")},inserted:function(){T._loaded&&v()}};function c(){return T._page?T._page._index:N.document.getPageIndexByImageIndex(T._index)}function D(){return T._domEl}function l(e){return N.document.getPageFitMultiplier(void 0!==e?e:c())}function u(e,t){return(e=void 0===e?W.zoom:e)*l(t)}function s(){var e=xe(c())||q.size;return{height:e.height,width:e.width}}
/**
     * Returns physical size of the image without client transformations applied(like view rotation)
     */function d(){var e=s();return 90===T._viewrotation||270===T._viewrotation?V(e):e}function C(e,t){return t=t||s(),{height:Math.round(t.height*u(e)),width:Math.round(t.width*u(e))}}function h(){var n=this;if(T._tiled){var o=0;return T.find("."+zn.atala_tile_column).first().find("img").each(function(e,t){Bn(this,n),o+=t.naturalHeight}.bind(this)),o}return T.prop("naturalHeight")}function f(){var e=this;if(T._tiled){var t=0;return T.find("."+zn.atala_tile_column).each(function(){Bn(this,e),t+=pn(this).find("img").first().prop("naturalWidth")}.bind(this)),t}return T.prop("naturalWidth")}function g(e){var _=c(),w=q.vector&&(!P||!P.uri)?u():Math.min(u(),1),z=N.document.getPageRotation(_);if(e||w!==T._zoom||T._rotation!==z){var k=pn.extend({atala_docurl:P?P.uri:T.documenturl,atala_doczoom:w,atalamultiprocessing:W.multiprocessing,atala_framecount:q.count,atala_thumbpadding:!1},r);if(z&&(k.atala_angle=z),W.jpeg&&(k.atala_jpeg=!0),W.tiling&&W.forcepagefit&&!T._loaded)if(ye(j*q.dpi/96,_)){var t,n=_e(),o=xe(_);t=o.width>o.height?n.width/o.width:n.height/o.height,oe(w,t)||(w=t,k.atala_doczoom=w)}if(T._tiled=function(e,t){var n=!1,o=j*q.dpi/96;if(W.tiling&&!L&&ye(o,e)){var i=_e(),a=xe(e);a.height>o&&a.width>o&&(2<a.height*t/i.height||2<a.width*t/i.width)&&(n=!0)}return n}(_,w),T._tiled)!function(){var n=this,s=xe(_),e=C(),t=_e(),c=Math.min(R,Math.floor(e.height/t.height)),u=Math.min(R,Math.floor(e.width/t.width)),d={width:Math.ceil(s.width/u),height:Math.ceil(s.height/c)};if(c!==T._tilesV||u!==T._tilesH){$e();var o=D(),i=T;T=X(),o.children().replaceWith(T),E(i),T.addClass(zn.atala_tiled_page_image);for(var a=0;a<u;a++){var r=X(T);r.addClass(zn.atala_tile_column);for(var l=0;l<c;l++){var h=X(r);h.attr("tile_index_h",a).attr("tile_index_v",l),h.width(d.width*w),h.height(d.height*w),h.addClass(zn.atala_page_loading);var f=pn(new Image);f.css("display","none"),h.append(f)}}T._tilesH=u,T._tilesV=c}(B.loadedImgs[T._cacheIndex]=T)._needToInsert=!1,T.__tileRequests=[],T.__tilesArray=[];for(var g=0;g<u;g++)for(var p=0;p<c;p++)T.__tilesArray.push({x:g,y:p});var m={x:0,y:0},v=function(e,t){return Bn(this,n),Math.pow(e.x-t.x,2)+Math.pow(e.y-t.y,2)}.bind(this);T.__tilesArray.sort(function(e,t){return Bn(this,n),v(m,e)-v(m,t)}.bind(this)),T.__tilesArray.forEach(function(e){var t,n,o,i,a=e.x,r=e.y;switch(z){case 0:t=Math.ceil(a*d.width),n=Math.ceil(r*d.height),o=a<u-1?d.width:s.width-t,i=r<c-1?d.height:s.height-n;break;case 90:t=Math.ceil(r*d.height),n=Math.ceil((u-1-a)*d.width),o=r<c-1?d.height:s.height-t,i=0!==a?d.width:s.width-n;break;case 270:t=Math.ceil((c-1-r)*d.height),n=Math.ceil(a*d.width),o=0!==r?d.height:s.height-t,i=a<u-1?d.width:s.width-n;break;case 180:t=Math.ceil((u-1-a)*d.width),n=Math.ceil((c-1-r)*d.height),o=0!==a?d.width:s.width-t,i=0!==r?d.height:s.height-n;break;default:Z("ImageError","Invalid rotation angle: "+z)}var l=pn.extend(!0,{},k,{atala_tilestart:t+"x"+n,atala_pagesize:o+"x"+i});l.atala_doczoom=w,T.__tileRequests.push({type:"docpage",serverurl:W.serverurl,query:"?ataladocpage="+(null===P?T._index:void 0!==P.index?P.index:P),method:"GET",data:l,cancel:!1})}),T._reqzoom=w,T._reqangle=z;for(var b=T._tilesLoadedCount=0;(b=Math.floor(2147483647*Math.random()))===U.tilingCorrelationId;);if(U.tilingCorrelationId=b,W.multiprocessing)for(var x=function(e){var t=this;et(),setTimeout(function(){Bn(this,t),M(e,d)}.bind(this),0)},y=0;y<T.__tilesArray.length;y++)x(y);else setTimeout(function(){Bn(this,n),et(),M(0,d)}.bind(this),0)}();else{if(1<T._tilesV||1<T._tilesH){var i=D(),a=T;T=pn(new Image),i.children().replaceWith(T),E(a),T.addClass(zn.atala_page_image),i.addClass(zn.atala_page_loading),T._tilesV=1,T._tilesH=1,T.__tilesArray=[],(B.loadedImgs[T._cacheIndex]=T)._needToInsert=!1}T._reqzoom=w,T._reqangle=z,Yt({type:"docpage",serverurl:W.serverurl,query:"?ataladocpage="+(null===P?T._index:void 0!==P.index?P.index:P),method:"GET",data:k,cancel:!1,info:T},p,p)}}}function M(t,n){function o(){return e!==U.tilingCorrelationId||U.itch||T._reqzoom!==u()||T._reqangle!==N.document.getPageRotation(c())||void 0===T.__tileRequests[t]||void 0===T.__tilesArray[t]}var e=U.tilingCorrelationId;if(o())g();else{var i=T.__tileRequests[t],a=T.__tilesArray[t].x,r=T.__tilesArray[t].y,l=T.find('div[tile_index_h="'+a+'"][tile_index_v="'+r+'"]').find("img");l.attr("tile_index",t),l.attr("src",i.serverurl+i.query+"&"+pn.param(i.data)),l[0].onload=function(){if(T&&!o()){if(T._tilesLoadedCount++,l.css("display","block"),l.parent().css({width:"auto",height:"auto"}),l.parent().removeClass(zn.atala_page_loading),0===t){var e=C();T.trigger({type:"pageresize",image:T,index:c(),width:e.width,height:e.height})}0===l.width()&&0===l.height()&&l.css({width:"auto",height:"auto"}),W.multiprocessing?T._tilesLoadedCount>=T.__tilesArray.length&&p():t<T.__tilesArray.length-1?M(t+1,n):p()}}}}function p(){T._loaded||T._domEl.removeClass(zn.atala_page_loading),T._tiled&&U.zooming&&vt(),T._loaded=!0,T._zoom=T._reqzoom,T._rotation=T._reqangle;var e=c();if(0<=e){if(T._rotation!==N.document.getPageRotation(e))return void g();(T._viewrotation=0)<T.parent().length&&v(),F(T._viewrotation);var t=q.vector?u():Math.min(u(),1);y()&&T._zoom<t*i&&!oe(T._zoom,t)&&x(!1)}k()}function E(e){T._loaded=e._loaded,T._zoom=e._zoom,T._rotation=e._rotation,T._prevzoom=e._prevzoom,T._scaledzoom=e._scaledzoom,T._binds=e._binds,T.documenturl=e.documenturl,T._index=e._index,T._size=e._size,T._viewrotation=e._viewrotation,T._tiled=e._tiled,T._page=e._page,T._reqzoom=e._reqzoom,T._domEl=e._domEl,T._cacheIndex=e._cacheIndex,T.dispose=b,T.zoom=x,T.needsZoom=y,T.getSize=s,T.getScaledSize=C,T.getFitZoom=u,T.getFitMultiplier=l,T.needsRotate=S,T.rotate=I,T.getDomElement=D,T.invalidate=O,T.naturalHeight=h,T.naturalWidth=f,T.on(a)}function m(e){e&&(e.removeAttr("width height"),e.css({width:"auto",height:"auto"}))}function v(){m(T);var e=T.naturalWidth()||0,t=T.naturalHeight()||0,n=e||T.width(),o=t||T.height(),i=s(),a=u(),r=!1;if(vn.Explorer&&!L&&n<40&&T._zoom>ie()&&(n=i.width*a,o=i.height*a),0!==n&&0!==o){T._tiled||(T._size.width=Math.round(n/T._zoom),T._size.height=Math.round(o/T._zoom)),90!==T._viewrotation&&270!==T._viewrotation||(T._size=V(T._size)),T._size.width===q.size.width&&T._size.height===q.size.height||oe(T._size.width,i.width)&&oe(T._size.height,i.height)||(r=!0,N.document.setPageSize(c(),T._size)),null===N.document.getPageSize(c())&&(r=!0,N.document.setPageSize(c(),T._size)),W.forcepagefit?z():(T._zoom!==W.zoom||r||0!==T._viewrotation)&&w();var l=C();r&&T.trigger({type:"pagesizechanged",image:T,index:c(),width:T._size.width,height:T._size.height,dx:Math.round(l.width-i.width*a),dy:Math.round(l.height-i.height*a)}),T.trigger({type:"pageresize",image:T,index:c(),width:l.width,height:l.height})}}function b(){T.off(a),T._page=null,T=null}function x(e,t){!y()||T._size.isEmpty()&&!T._tiled?"function"==typeof t&&t.call(this,T):("function"==typeof t&&o.push(t),T._prevzoom=T._reqzoom,e&&!U.loading?T._tiled?T.find("img").each(function(){var e=pn(this);e.animate({height:Math.round(e.height()/T._reqzoom*u()),width:Math.round(e.width()/T._reqzoom*u())},{duration:H,easing:"easeOutQuad",complete:_,queue:!1})}):T.animate({height:Math.round(T._size.height*u()),width:Math.round(T._size.width*u())},{duration:H,easing:"easeOutQuad",complete:_,queue:!1}):(w(),_()))}function y(){if(!T._loaded&&!T._tiled)return!1;var e=!q.vector&&1===T._reqzoom&&1===T._prevzoom&&1<u(),t=oe(T._reqzoom,u())||e;if(!t){var n=Math.abs(T._reqzoom*T._size.width-u()*T._size.width),o=Math.abs(T._reqzoom*T._size.height-u()*T._size.height);n<1&&o<1&&(t=!0)}return!t||!oe(T._scaledzoom,u())}function _(){var e=u();T.trigger({type:"pagezoom",index:c(),height:Math.round(T._size.height*e),width:Math.round(T._size.width*e),prevzoom:T._prevzoom,zoom:e}),0===U.prpr?g():k()}function w(){var e,t,n,o=C(void 0,d()),i=C(),a=T.naturalWidth()||0,r=T.naturalHeight()||0,l=a&&Math.abs(a-o.width)/o.width<.01,s=r&&Math.abs(r-o.height)/o.height<.01;l&&s||(T._tiled&&0!==r&&0!==a?T.find("img").each(function(){var e=pn(this),t=e.prop("naturalHeight"),n=e.prop("naturalWidth");0!==t&&0!==n&&(e.height(t*u()),e.width(n*u()))}):(T.height(o.height),T.width(o.width))),T._domEl.width(i.width),T._domEl.height(i.height),T._scaledzoom=u(),T._tiled?A(T._viewrotation):F(T._viewrotation),e=c(),t=i.width,i.height,null!=(n=at(e))&&null!=n._num&&n._num.css({left:t-20,right:0})}function z(){var e,t=function(e){var t=1;e=e||T._size;var n={width:W.forcepagesize.width*(L?1:W.zoom),height:W.forcepagesize.height*(L?1:W.zoom)};(n.width<1||n.height<1)&&(n.width=q.size.width*W.zoom,n.height=q.size.height*W.zoom);t=e.width/n.width>e.height/n.height?n.width/e.width:n.height/e.height;return t}();e=t/W.zoom,N.document.setPageFitMultiplier(c(),e),w()}function k(){0<o.length&&function(e){var t=Array.prototype.slice.call(arguments,1);for(;e.length;)e.shift().apply(this,t)}(o,T)}function S(){var e=N.document.getPageRotation(c());return 0===T._viewrotation&&e!==T._rotation||0!==T._viewrotation}function I(e){if("function"==typeof e&&o.push(e),S()){var t=N.document.getPageRotation(c());if(n=N.document.getPageRotation(c()),(0===T._viewrotation&&n!==T._rotation||0!==T._viewrotation&&(T._viewrotation+T._rotation)%360!==n)&&T&&T._page&&(t=(360+t-T._rotation)%360,!T._tiled&&T._loaded?(F(t),v()):T._tiled&&(A(t),function(){m(T);var e=c(),t=N.document.getPageSize(e);if(90===T._viewrotation||270===T._viewrotation){var n=V(t);T._size.width=n.width,T._size.height=n.height,N.document.setPageSize(e,T._size)}W.forcepagefit?z():T._zoom===W.zoom&&0===T._viewrotation||w()}(),0!==(i=t)&&T.find("img").each(function(){var e=pn(this),t={width:e.width(),height:e.height()};90!==i&&270!==i||(t=V(t));var n=e.parent();0!==t.width&&0!==t.height&&(n.width(t.width),n.height(t.height)),n.addClass(zn.atala_page_loading);var o=pn(new Image);o.css("display","none"),n.children().replaceWith(o)}))),0===U.prpr&&T._loaded)return void g()}var i,n;k()}function F(e){var t=d(),n=C(void 0,t),o=0,i=0,a="";90!==e&&270!==e||(o=(n.height-n.width)/2,L&&t.width<t.height&&(o=0),i=(n.width-n.height)/2,n=V(n)),0!==e?(a+=" translate("+o+"px,"+i+"px)",a+="rotate("+e+"deg)",T.css(Dn(a))):T.css(Dn("")),D().css({width:n.width,height:n.height}),T._viewrotation=e}function A(e){var t=C(void 0,d());90!==e&&270!==e||(t=V(t)),D().css({width:t.width,height:t.height}),T._viewrotation=e}function O(e,t){"function"==typeof e&&(t=e,e={}),(r=pn.extend(!0,{},e)).atala_cb=Math.floor(1e9*Math.random()),"function"==typeof t&&o.push(t),g(!0)}function V(e){var t=e.width;return e.width=e.height,e.height=t,e}return T._binds=a,T.documenturl=W.documenturl,T._index=P?P.mapsto:e,T._loaded=!1,T._size={width:0,height:0,isEmpty:function(){return 0===this.width&&0===this.height}},T._zoom=-1,T._prevzoom=T._zoom,T._scaledzoom=-1,T._rotation=0,T._viewrotation=0,T._tiled=!1,T._tilesV=1,T._tilesH=1,T.dispose=b,T.zoom=x,T.needsZoom=y,T.getSize=s,T.getScaledSize=C,T.getFitZoom=u,T.getFitMultiplier=l,T.needsRotate=S,T.rotate=I,T.getDomElement=D,T.invalidate=O,T.naturalHeight=h,T.naturalWidth=f,function(){T.on(a);var e=W.pageborderwidth,t={bottom:0,top:0,right:0,left:0};T._loaded=!1,T._reqzoom=-1,T._needToInsert=!0,(W.direction===xn.Vertical||W.tabular)&&(t.bottom=W.pagespacing);(W.direction===xn.Horizontal||W.tabular)&&(t.right=W.pagespacing);var n=D();W.showpageborder&&n.css({"border-bottom":e+"px solid black","border-right":e+"px solid black","border-top":e+"px solid silver","border-left":e+"px solid silver","margin-bottom":t.bottom+"px","margin-right":t.right+"px"});n.css({display:"inline-block"}),n.addClass(zn.atala_page_loading),g()}(),T}function $(e,t){var n=X(e);n.css({position:"absolute",display:"none","background-color":"white"});var o=null,i=!1;function a(){o._tooltip.hide(),q.number===o._pagenum||it(o._pagenum)||qe(o._pagenum),Ut()}function r(e,t){if(W.forcepagefit){t*=e._ratio;var n=e.ScrollDirection===xn.Vertical?{x:0,y:t}:{x:t,y:0};return ce(n.x,n.y)+1}return Math.floor(t/(e._max/N.document.getPageCount()))+1}return t===xn.Horizontal?(o=vn.Firefox?pn('<div class="atala_scrollbar_firefox_x"></div>').appendTo(e):pn('<div class="atala_scrollbar_x"></div>').appendTo(e))._tray=pn("<div/>").css("height","1px").appendTo(o):(vn.Firefox?(o=pn('<div class="atala_scrollbar_firefox_y"></div>').css("width",function(){var e=X(pn("body")),t=X(e);e.css({width:"50px",height:"50px",overflow:"hidden",position:"absolute",visibility:"hidden"}),t.css({width:"100px",height:"100px"});var n=e.width();e.css({"overflow-y":"scroll"});var o=n-e[0].clientWidth;return pn(e).remove(),o}()+1+"px;").appendTo(e),i=!0):o=pn('<div class="atala_scrollbar_y"></div>').appendTo(e),o._explicitSize=i,o._tray=pn("<div/>").css("width","1px").appendTo(o)),te(o),o._ratio=1,o.ScrollDirection=t,o._tooltip=n,o._pagenum=-1,o._scrollSize=0,o.pageNum=function(e){o._pagenum=e},o.scrollbarHeight=function(){return o.height()-o[0].clientHeight},o.scrollSize=function(e){o._scrollSize=e},o.ratio=function(e){o._ratio=e},o.on({scroll:function(){if(!o.propagationPaused()){clearTimeout(o._tooltip._timeout),B.scroller.stop(),B.scroller.pauseEventPropagation(!0);var e={};o.ScrollDirection===xn.Vertical?(B.scroller.scrollTop(o[0].scrollTop*o._ratio),o._pagenum=x?rn()+1:r(o,o[0].scrollTop),e.right=o.outerWidth()+10+"px",e.top=16+Math.round((o[0].offsetHeight-48)/o[0].scrollHeight*o[0].scrollTop)+"px",o.attr("aria-valuenow",o.scrollTop()/o._max)):o.ScrollDirection===xn.Horizontal&&(B.scroller.scrollLeft(o[0].scrollLeft*o._ratio),o._pagenum=x?rn()+1:r(o,o[0].scrollLeft),e.bottom=o.outerHeight()+10+"px",e.left=16+Math.round((o[0].offsetWidth-48)/o[0].scrollWidth*o[0].scrollLeft)+"px",o.attr("aria-valuenow",o.scrollLeft()/o._max)),o.ScrollDirection===W.direction&&W.showpagenumbertooltip&&("none"===o._tooltip.css("display")&&(o._tooltip.css(e),o._tooltip.show()),W.showpagenumbertooltip&&o._tooltip.html("Page "+o._pagenum),o._tooltip._timeout=setTimeout(a,1e3))}}}),o}function ee(e){e&&e._tooltip&&(clearTimeout(e._tooltip._timeout),e._tooltip.hide())}function te(t){var n={scroll:function(){t.off(n),t.resumeEventPropagation()}};t._pauseEP=0,t.propagationPaused=function(){return 0<t._pauseEP},t.pauseEventPropagation=function(e){t._pauseEP++,e&&t.on(n)},t.resumeEventPropagation=function(){0<t._pauseEP&&t._pauseEP--}}function ne(e){var t=_e(),n=re(0,e);!U.hidden&&t.height<=0&&t.width<=0&&(U.hidden=!0,function(){var e=this;if(vn.Edge||vn.Explorer)var t=setInterval(function(){Bn(this,e),0!==B.scroller.height()&&0!==B.scroller.width()&&(clearInterval(t),U.hidden=!1,cn("viewportunhide"))}.bind(this),500);else{var n=new ResizeObserver(function(){Bn(this,e),U.hidden=!1,cn("viewportunhide"),n.unobserve(B.scroller[0])}.bind(this));n.observe(B.scroller[0])}}()),n.width=0<q.smallest.width&&q.smallest.width<n.width&&!L?q.smallest.width:n.width,n.height=0<q.smallest.height&&q.smallest.height<n.height&&!L?q.smallest.height:n.height;var o,i=Math.ceil(t.width/n.width)+2,a=Math.ceil(t.height/n.height)+2;return W.tabular?(W.direction===xn.Vertical&&0<W.columns?i=W.columns:W.direction===xn.Horizontal&&0<W.rows&&(a=W.rows),o=i*a):W.direction===xn.Vertical?o=a:W.direction===xn.Horizontal&&(o=i),o}function oe(e,t){return t<e+.001&&e-.001<t}function ie(){return 0!==q.size.width?W.minwidth/q.size.width:1}function ae(){return 0!==q.size.width?W.maxwidth/q.size.width:1}function re(e,t,n){if(N.document.getPageCount()<=0)return{width:0,height:0};if(n=void 0===n||n,U.newpagedivsize){var o={width:U.newpagedivsize.width,height:U.newpagedivsize.height},i=W.showpageborder&&n?2*W.pageborderwidth:0,a=(t||W.zoom)/U.newpagedivfullzoom;return o.height=Math.round(o.height*a)+i,o.width=Math.round(o.width*a)+i,o}return le(e,t||W.zoom,W.showpageborder&&n)}function le(e,t,n){var o,i=pn.extend({},xe(e)),a=n?2*W.pageborderwidth:0;return t*=(o=e,N.document.getPageFitMultiplier(o)),i.height=Math.round(i.height*t)+a,i.width=Math.round(i.width*t)+a,i}function se(e,t){return ge(null,e,t).index}function ce(e,t){var n=he(),o=_e();if(W.direction===xn.Vertical){var i=0;if(B.scrollH&&(i=1,"none"!==B.scrollH.find("div").css("display")||vn.Firefox||(i=B.scrollH.outerHeight(!0))),t>=n.height-o.height-i&&0<U.scrollTarget.Page)return U.scrollTarget.Page-1}var a=B.scrollV&&"none"!==B.scrollV.find("div").css("display")?1:0;if(W.direction===xn.Horizontal&&e===n.width-o.width-a&&0<U.scrollTarget.Page)return U.scrollTarget.Page-1;var r={x:e+W.pageselectlocation.x*o.width,y:t+W.pageselectlocation.y*o.height};return se(r.x,r.y)}function ue(e,t){for(var n={left:0,top:0},o=e;null!=o&&o!==t;o=o.offsetParent)n.left+=o.offsetLeft,n.top+=o.offsetTop;return n}var de={height:0,isEmpty:function(){return 0===this.width&&0===this.height},width:0,zero:function(){this.width=0,this.height=0},zoom:1};function he(){if(de.isEmpty()||de.zoom!==W.zoom){var e=ge(null,null,null,W.zoom);de.height=e.height,de.width=e.width,de.zoom=W.zoom}return de}function fe(){de.zero(),he()}function ge(e,t,n,o){return pe(0,e,t,n,o)}function pe(e,t,n,o,i){if(W.tabular)return function(e,t,n,o,i){if(t<e)return{width:0,height:0,index:t};var a=me(e,n,o,i),r=me(t,n,o,i);return r.height=W.direction===xn.Vertical?r.height-a.height:r.height,r.width=W.direction===xn.Horizontal?r.width-a.width:r.width,r}(e,t,n,o,i);var a=N.document.getPageCount();e=e||0,t=t||0===t?t:a,x&&(a=1,t=e=0);var r={height:0,width:0,index:e};if(W.direction===xn.Vertical)for(var l=null,s=e;s<a&&s<t&&(r.height+(l=re(s,i).height)<=o||null==o);s++)r.height+=l+W.pagespacing,r.index++;else if(W.direction===xn.Horizontal)for(var c=null,u=e;u<a&&u<t&&(r.width+(c=re(u,i).width)<=n||null==n);u++)r.width+=c+W.pagespacing,r.index++;return r.index>=a&&0<a&&(r.index=a-1),r}function me(e,t,n,o){var i,a,r=N.document.getPageCount(),l={height:0,width:0,index:0},s=ve(o);e=null==e?e=r:e,W.direction===xn.Vertical?(i=s||1,a=Math.ceil(r/i)):W.direction===xn.Horizontal&&(a=s||1,i=Math.ceil(r/a));var c=re(0,o);c.width+=W.pagespacing,c.height+=W.pagespacing;var u=null==n?Math.floor(e/i):Math.floor(n/c.height),d=null==t?e%i:Math.ceil(t/c.width);return l.height=u*c.height,l.width=d*c.width,l.index=u*i+d,l.index>=r&&0<r&&(l.index=r-1),l}function ve(e){if(x)return 1;var t=1;if(W.tabular){var n=W.pagespacing||0,o=re(0,e);W.direction===xn.Vertical?(t=Math.floor(B.content.width()/o.width),t=Math.min(t,Math.floor((B.content.width()-t*n)/o.width))):W.direction===xn.Horizontal&&(t=Math.floor(B.content.height()/o.height),t=Math.min(t,Math.floor((B.content.height()-t*n)/o.height)))}return t||1}function be(e,t){var n=xe(e);return(Tt(e)+(t||0))%180==0?n:{width:n.height,height:n.width}}function xe(e){var t=N.document.getPageSize(e);return t||q.size}function ye(e,t){return N.document.canBeTiled(e,t)}function _e(){return{width:B.scrollV?B.main.width()-B.scrollV.outerWidth():B.main.width(),height:B.scrollH?B.main.height()-B.scrollH.outerHeight():B.main.height()}}function we(e,t){var n={status:"fail",started:!1,reason:e};return"function"==typeof t&&t.call(),n}function ze(e,t,n,o,i,a){var r=ue(e,t);return r.left<=i&&r.left+e.clientWidth>=n&&r.top<=a&&r.top+e.clientHeight>=o}function ke(e,t,n){return t<e.length&&(e.splice(n,0,e.splice(t,1)[0]),!0)}function Pe(e){W.showstatus&&B.status&&B.status.html(e),cn({type:"statusmessage",message:e})}function Te(e,t){var n;if(1===e.length&&"object"==typeof e[0])n=e[0];else if("string"==typeof e[0]){n={};var o=null;3===e.length?o=e[2]:2===e.length&&(o=e[1]);for(var i=-1<e[0].indexOf(" ")?e[0].split(" "):[e[0]],a=0;a<i.length;a++)n[i[a]]=o}for(var r in n)if(n.hasOwnProperty(r)){var l=null;if(r in d?l=d:c&&r in c.annotations.events?l=c.annotations.events:c&&r in c.forms.events?l=c.forms.events:c&&r in c.document.events&&(l=c.document.events),null==l&&(l=d),null==l[r])t&&(l[r]=[n[r]]);else if(t)l[r].push(n[r]);else if(n[r])for(var s=0;s<l[r].length;s++)l[r][s]===n[r]&&l[r].splice(s,1);else l[r].length=0}}function De(e,t){return t?isFinite(parseFloat(e)):isFinite(parseInt(e,10))}function Ce(e,t,n,o,i){if(null==i&&"function"==typeof o&&(i=o,o=null),e=null==e?B.scroller.scrollLeft():e,t=null==t?B.scroller.scrollTop():t,W.direction===xn.Horizontal){if(e>B.viewport.width()){var a=he();if(e<a.width&&0<B.content.width()){var r=a.width-(B.edges[0].width()+B.content.width());B.edges[1].width(r)}}}else if(W.direction===xn.Vertical&&t>B.viewport.height()){var l=he();if(t<l.height&&0<B.content.height()){var s=l.height-(B.edges[0].height()+B.content.height());B.edges[1].height(s)}}B.scroller.stop(),!n||U.loading||U.scrollPos.x===e&&U.scrollPos.y===t?(B.scroller.scrollLeft(e),B.scroller.scrollTop(t),"function"==typeof i&&i.call()):pn.when(B.scroller.animate({scrollLeft:e,scrollTop:t},{duration:o||u,easing:"easeOutQuad",queue:!1})).done(i)}function Me(e,t){if(B.scroller.is(":animated"))return we("scrolling",t);var n=ge(q.number+e-1);Ce(n.width,n.height,!0,t)}function Ee(){if(B.scrollH&&B.scrollV){var e=x?1:N.document.getPageCount();if(B.scrollH.pauseEventPropagation(),B.scrollV.pauseEventPropagation(),W.direction===xn.Vertical){Ie(B.scrollH,"width");var t=x?rn():e-1,n=Math.round(ge(e-1).height+re(t).height);vn.Firefox&&(n+=Math.round(B.scrollH.scrollbarHeight())),B.scrollV.scrollSize(n-(B.scrollV.height()-B.scrollH.scrollbarHeight()-1)),3e4<n?(B.scrollV.ratio(n/(3e4-(B.scrollV.height()-B.scrollH.scrollbarHeight()-1))),B.scrollV._tray.height(3e4)):(B.scrollV._tray.height(n),B.scrollV.ratio(1)),Fe(B.scrollV)}else if(W.direction===xn.Horizontal){Ie(B.scrollV,"height");var o=x?rn():e-1,i=Math.round(ge(e-1).width+re(o).width);B.scrollH.scrollSize(i),3e4<i?(B.scrollH.ratio(i/(3e4-(B.scrollH.width()-B.scrollV.width()-1))),B.scrollH._tray.width(3e4)):(B.scrollH._tray.width(i),B.scrollH.ratio(1)),Fe(B.scrollH),He(o,null)}B.scrollV._max=Math.max(B.scrollV._tray.height()-B.scrollV.height(),0)+1,B.scrollH._max=Math.max(B.scrollH._tray.width()-B.scrollH.width(),0)+1,B.scrollH.resumeEventPropagation(),B.scrollV.resumeEventPropagation()}}function Se(e,t){if(W.direction===xn.Vertical){if(B.scrollV)if(B.scrollV.scrollSize(Math.max(B.scrollV._scrollSize+t,0)),1===B.scrollV._ratio&&B.scrollV._scrollSize+t<3e4)B.scrollV._tray.height(B.scrollV._tray.height()+t),B.scrollV._max=Math.max(B.scrollV._tray.height()-B.scrollV[0].clientHeight,0)+1;else{var n=B.scrollV.height()-B.scrollH.scrollbarHeight()-1,o=(3e4-n)*B.scrollV._ratio;3e4<o+t?B.scrollV.ratio((o+t)/(3e4-n)):Ee()}Fe(B.scrollV),Ie(B.scrollH,"width")}else if(W.direction===xn.Horizontal){if(B.scrollH)if(B.scrollH.scrollSize(Math.max(B.scrollH._scrollSize+e,0)),1===B.scrollH._ratio&&B.scrollH._scrollSize+e<3e4)B.scrollH._tray.width(B.scrollH._tray.width()+e),B.scrollH._max=Math.max(B.scrollH._tray.width()-B.scrollH[0].clientWidth,0)+1,B.scrollH.ratio(B.scrollH._scrollSize/B.scrollH._max);else{var i=B.scrollH.width()-B.scrollV.width()-1,a=(3e4-i)*B.scrollH._ratio;3e4<a+e?B.scrollH.ratio((a+e)/(3e4-i)):Ee()}Fe(B.scrollH),Ie(B.scrollV,"height")}if((0!==e||0!==t)&&0!==t){var r=B.scroller[0].scrollLeft,l=B.scroller[0].scrollTop;We(x?rn()+1:ce(r,l)+1),cn({type:"scroll",x:r,y:l,dx:0,dy:0})}}function Ie(e,t){if(e&&B.pageDivs.length){var n=Math.round(q.size[t]*W.zoom);if(W.tabular)n=B.content[t]();else for(var o=x?1:B.pageDivs.length,i=0;i<o;i++)null!=B.pageDivs[i]._index&&(n=Math.max(re(B.pageDivs[i]._index)[t],n));e._tray[t](n),e.scrollSize(n-e[t]()),Fe(e),e.ratio(1)}}function Fe(e){e&&(e._scrollSize<=0?e._tray.hide():e._tray.show())}var Ae=!1;function Oe(e){if(!U.zooming&&!U.scrollBuffer&&B.pageDivs.length){var t=(new Date).getTime(),a=B.scroller[0].scrollLeft,r=B.scroller[0].scrollTop;if(!U.loading){if(!x){var n=a+B.scroller[0].clientWidth,o=r+B.scroller[0].clientHeight,i=se(a,r)+1,l=Math.abs(i-q.number)/ve(),s=N.document.getPageCount(),c=B.pageDivs[0]._index,u=B.pageDivs[B.pageDivs.length-1]._index,d=0===l&&(q.number-1<c||q.number-1>u);if(l<B.pageDivs.length&&!d)ze(B.edges[1][0],B.scroller[0],a,r,n,o)&&u<s-1?Be(l):ze(B.edges[0][0],B.scroller[0],a,r,n,o)&&0<c?je(l):i!==q.number&&null===at(i-1)&&qe(i);else{var h=B.scroller[0].scrollLeft,f=B.scroller[0].scrollTop;Ue(i,Ae=!1,null),W.direction===xn.Vertical&&h!==B.scroller[0].scrollLeft&&(B.scroller.scrollLeft(h),Ae=!0),W.direction===xn.Horizontal&&f!==B.scroller[0].scrollTop&&(B.scroller.scrollTop(f),Ae=!0)}}wt()}if(We(x?q.number:ce(a,r)+1),!B.scroller.propagationPaused()&&B.scrollH&&B.scrollV){var g=Math.round(a/B.scrollH._ratio),p=Math.round(r/B.scrollV._ratio);g!==B.scrollH.scrollLeft()&&(B.scrollH.pauseEventPropagation(!0),B.scrollH.scrollLeft(g)),p!==B.scrollV.scrollTop()&&(B.scrollV.pauseEventPropagation(!0),B.scrollV.scrollTop(p))}cn({type:"scroll",x:a,y:r,dx:a-U.scrollPos.x,dy:r-U.scrollPos.y}),e&&(U.scrollTimeout&&clearTimeout(U.scrollTimeout),U.scrollTimeout=setTimeout(function(){var e,t,n,o,i;e=a,t=r,n=B.scroller[0].scrollLeft,o=B.scroller[0].scrollTop,i=n===U.scrollPos.x&&o===U.scrollPos.y,e===U.scrollPos.x&&t===U.scrollPos.y&&i?(Ut(),U.scrollTimeout=null,U.loading||wt()):i?i&&Ae?Math.abs(e-U.scrollPos.x)<3&&Math.abs(t-U.scrollPos.y)<3&&(Ut(),U.scrollTimeout=null,U.loading||wt()):i&&L&&q.buffer===W.maxpagebuffersize&&(Ut(),U.scrollTimeout=null,U.loading||wt()):(Oe({}),U.scrollTimeout=null)},500),U.scrollPos.x=B.scroller[0].scrollLeft,U.scrollPos.y=B.scroller[0].scrollTop,U.scrollPos.t=t),U.scrollBuffer=e?setTimeout(Ve,50):null}}function Ve(){null!==U.scrollBuffer&&(clearTimeout(U.scrollBuffer),U.scrollBuffer=null)}function Le(){if(W.direction===xn.Horizontal){var e=B.pageDivs.length?(L?Math.max(q.size.height,q.size.width):q.size.height)*W.zoom:0;W.thumbpadding&&"number"==typeof W.thumbpadding&&(e+=2*W.thumbpadding),B.edges[0].height(e),B.edges[1].height(e)}}function He(e,t){t=t||0===t?t:e+B.pageDivs.length-1,t=Math.max(e,t);var n=W.tabular?ve():1,o=W.tabular?(Math.floor(t/n)+1)*n-t:1,i=ge(e),a=x?1:N.document.getPageCount();x&&(t=e=0);var r=t<a?re(t):{width:0,height:0},l=x?rn():a-1,s=t<a-n?re(l):{width:0,height:0},c=pe(e,t);c.width+=r.width,c.height+=r.height;var u=pe(t+1,a-1);if(u.width+=s.width,u.height+=s.height,W.direction===xn.Vertical)B.edges[0].height(i.height),(x?a:N.document.getPageCount())<=t+o?B.scrollH&&0===B.scrollH._tray[0].offsetWidth?B.edges[1].height(B.scrollH[0].offsetHeight-1):B.edges[1].height(0):(B.edges[1].height(u.height),vn.Chrome&&B.content.height(""));else if(W.direction===xn.Horizontal){if(B.edges[0].width(i.width),(x?a:N.document.getPageCount())<=t+o){var d=i.width+c.width+u.width;B.scrollV&&d>B.scroller[0].clientWidth&&B.content.height()<=B.scroller[0].clientHeight?B.scrollV._explicitSize?B.edges[1].width(B.scrollV.height()<B.scrollV._tray.height()?B.scrollV.width():0):B.edges[1].width(B.scrollV.width()):B.edges[1].width(0)}else B.edges[1].width(u.width),B.edges[1].height(1)}}function Re(){return U.activepage}function je(e){if(e=e||1,x)Ne(rn()-e);else if(0===U.prpr&&0<B.pageDivs.length){var t=ve(W.zoom);Qe();for(var n=e;0<n;n--){var o=B.pageDivs[0]._index-t;if(0<=o&&o<N.document.getPageCount()){for(var i=t-1;0<=i;i--){var a=tt(-1);Xe(a),B.content.prepend(a),Ye(a,ot(o+i),o+i)}He(o,null),Le()}}setTimeout(Ke,10)}}function Be(e){if(e=e||1,x){Ne(rn()+e)}else{var t=B.pageDivs[B.pageDivs.length-1]._index+1;if(0===U.prpr&&0<B.pageDivs.length&&t<N.document.getPageCount()){Qe();for(var n=ve(W.zoom),o=N.document.getPageCount(),i=e;0<i;i--){var a=B.pageDivs[B.pageDivs.length-1]._index+1;if(a<o){for(var r=a+n-1-B.pageDivs.length,l=0;l<n;l++){var s=tt(1);Xe(s),B.content.append(s),Ye(s,ot(a+l),a+l)}He(r+1,a),Le()}}setTimeout(Ke,10)}}}
/**
...
/**
   ...
   */function qe(e,t){var n=this;if(W.direction===xn.Vertical?B.scrollV&&clearTimeout(B.scrollV._tooltip._timeout):W.direction===xn.Horizontal&&B.scrollH&&clearTimeout(B.scrollH._tooltip._timeout),e=Math.max(1,e),e=Math.min(N.document.getPageCount(),e),x)Ue(e,!1,t);else{if(L||U.zooming||(U.scrollTarget.Page=e),q.number!==e){var o=e-q.number;Math.abs(o)<B.pageDivs.length?Me(o,t):Ue(e,!0,t)}else Me(0,t);setTimeout(function(){return Bn(this,n),U.scrollTarget.Page=0}.bind(this),1e4)}}function Ue(e,t,n){var o=N.document.getPageCount(),i=e-1;if(0===U.prpr&&0<o){var a=function(){x?(Ee(),Ke()):Ke(!t),"function"==typeof n&&n.call()};if(Qe(),x){if(W.direction===xn.Vertical){var r=ge(0).height;B.edges[0].height(r)}else if(W.direction===xn.Horizontal){var l=ge(0).width;B.edges[0].width(l)}He(0,null),Le(),Ze();for(var s=0;s<B.pageDivs.length;s++)Ye(B.pageDivs[s],null,i+s);B.content.append(B.pageDivs[0]),Ut(),We(i+1),wt(!1,a)}else{var c=0,u=0,d=i<=0?0:i;if(d+B.pageDivs.length>=o){if(d=o-B.pageDivs.length,W.tabular){var h=ve();d=Math.ceil(d/h)*h}d=Math.max(d,0)}if(W.direction===xn.Vertical){c=ge(d).height,B.edges[0].height(c),He(d,null),Le(),Ze();for(var f=0;f<B.pageDivs.length;f++)B.content.append(B.pageDivs[f]),Ye(B.pageDivs[f],null,d+f);var g=ge(Math.max(i,0)).height,p=q.number<e?-q.size.height:q.size.height;t&&g!==U.scrollPos.y?(Ce(null,g+p,!1),Ce(null,g,!0,a)):a.call()}else if(W.direction===xn.Horizontal){u=ge(d).width,B.edges[0].width(u),He(d,null),Le(),Ze();for(var m=0;m<B.pageDivs.length;m++)B.content.append(B.pageDivs[m]),Ye(B.pageDivs[m],null,d+m);var v=ge(Math.max(i,0)).width,b=q.number<e?-q.size.width:q.size.width;t&&v!==U.scrollPos.x?(Ce(v+b,null,!1),Ce(v,null,!0,a)):a.call()}}}else we("paused",n)}function We(e){var t=N.document.getPageCount();if(0<e&&e<=t){if(q.number!==e||q.numberoutof!==t){if(B.pageLabel.html(e+" / "+t),q.number!==e){q.number=e;for(var n=0;n<B.pageDivs.length;n++){var o=B.pageDivs[n];o._index===e-1?o.addClass(zn.atala_active_page):o.removeClass(zn.atala_active_page)}cn({type:"pagenumberchanged",number:q.number})}q.numberoutof!==t&&(q.numberoutof=t)}}else B.pageLabel.html(""),B.viewport.find("."+zn.atala_active_page).removeClass(zn.atala_active_page),q.numberoutof=0}function Ze(){for(var e=B.pageDivs.length-1;0<=e;e--)Xe(B.pageDivs[e])}function Xe(e){vn.Explorer&&document.activeElement&&e.has(document.activeElement).length&&B.scroller.focus(),W.allowannotations&&(vn.Firefox||vn.Edge)&&N.annotations.__clearAllSelection(e),W.tiling&&e._img&&0<=e._img._cacheIndex&&(B.loadedImgs[e._img._cacheIndex]._needToInsert=!0),e.detach(),null!=e._img&&(e._img._page=null,e._img.getDomElement().detach(),e._img=null),cn({type:"pagerecycled",index:e._index,page:e}),e.removeAttr(kn.atala_page_index)}function Ge(e){Xe(e),e._index=-1,e.removeAttr(kn.atala_page_index),e._img=null,e.remove()}function Ye(t,e,n,o){if(t._index===n&&t._img===e&&!o)return!1;if(o&&!t.nullinserted&&n<0)return!1;if(e&&t._index===n&&!e._needToInsert)return!1;t._index=n,t.attr(kn.atala_page_index,n);var i=L?"Thumbnailer page number "+(n+1):"Viewer page number "+(n+1);(t.attr("role","img").attr("aria-label",i),t._paper)&&pn(t._paper.canvas).attr("aria-hidden","true");if(n>=N.document.getPageCount())return t.hide(),!1;if(t._img&&t._img!==e&&(t._img._page=null,0<t.has(t._img.getDomElement()).length&&t._img.getDomElement().detach(void 0,!0)),t._rubberband&&t._rubberband.reset(),t._img=e,t._img&&((t._img._page=t)._img.attr("alt",i),vn.Firefox&&L&&t._img.attr("aria-hidden","true")),t.css({display:W.tabular||W.direction===xn.Horizontal?"inline-block":"block",position:"relative"}),W.showpagenumber&&(t._num||(t._num=pn('<div class="atala_pg_num"/>'),t._num.addClass(zn.atala_page_number),t.append(t._num)),t._num.text(t._index+1)),t._img&&t._img._binds&&(t._img._binds.pageresize||(t._img._binds.pageresize=function(e){cn({type:"pageresize",page:e.image._page,image:e.image,index:e.image._page?e.image._page._index:N.document.getPageIndexByImageIndex(e.image._index),width:e.width,height:e.height})},t._img.on({pageresize:t._img._binds.pageresize})),t._img._binds.pagesizechanged||(t._img._binds.pagesizechanged=function(e){cn({type:"pagesizechanged",page:t,image:e.image,index:e.index,width:e.width,height:e.height,dx:e.dx,dy:e.dy})},t._img.on({pagesizechanged:t._img._binds.pagesizechanged}))),t._img){var a=t._img.getDomElement();if(t.append(a),t._img.trigger({type:"inserted",page:t}),!t._img._loaded)if(t.nullinserted)if(!L&&W.tiling&&W.forcepagefit){var r,l=t.width(),s=t.height();W.fitting===yn.Width?(r=(l=Math.ceil(q.size.width*W.zoom))/t.width(),s=Math.ceil(t.height()*r)):W.fitting===yn.Height&&(r=(s=Math.ceil(q.size.height*W.zoom))/t.height(),l=Math.ceil(t.width()*r)),t._img.css({width:l,height:s}),N.document.setPageFitMultiplier(t._index,r)}else t._img.css({width:t.width(),height:t.height()});else Je(t._img,t._index);U.newpagedivsize||t.css({width:"",height:""}),t.nullinserted=!1}else t.nullinserted=!0,U.newpagedivsize||Je(t,t._index);return cn({type:"pageshown",page:t,index:t._index}),!0}function Je(e,t){var n=re(t,null,!1);e.css({width:n.width,height:n.height})}function Qe(){U.prpr++}function Ke(e){0!==U.prpr&&(U.prpr--,0!==U.prpr||e||Oe())}function $e(){U.itch=!0}function et(){U.itch=!1}function tt(e){return 0<e?(ke(B.pageDivs,0,B.pageDivs.length-1),B.pageDivs[B.pageDivs.length-1]):(ke(B.pageDivs,B.pageDivs.length-1,0),B.pageDivs[0])}
/**
...
/**
   ...
   */
function nt(e,t){var n=pn.Deferred();0<=e.cacheIndex&&B.loadedImgs[e.cacheIndex]?B.loadedImgs[e.cacheIndex].invalidate(t,function(){n.resolve()}):n.resolve();return n.promise()}function ot(e,t,n){"function"==typeof t&&(n=t,t=void 0);var o=N.document.getPageDefinition(e);if(o){if(o.cacheIndex<0||!B.loadedImgs[o.cacheIndex]){var i=U.nextImageCacheIndex++;o.cacheIndex=i,N.document.setPageCacheIndex(e,i),B.loadedImgs[i]=K(o.index,o.ref,t,function(e){e&&((B.loadedImgs[i]=e)._cacheIndex=i,N.memory.allocate(e)),"function"==typeof n&&n.call()}),W.allowtext&&N.text&&!L&&N.text.ensurePageTextLoaded(e)}else"function"==typeof n&&n.call();return B.loadedImgs[o.cacheIndex]}}function it(e){var t=at(e);if(t){var n=B.scroller[0].scrollLeft,o=B.scroller[0].scrollTop;return ze(t[0],B.scroller[0],n,o,n+B.scroller[0].clientWidth,o+B.scroller[0].clientHeight)}return!1}function at(e){for(var t=null,n=0;n<B.pageDivs.length&&null===t;n++)B.pageDivs[n]._index===e&&(t=B.pageDivs[n]);return t}function rt(r,l,s,c,u){var d=this;c&&"function"==typeof c&&(u=c,c=!1);var e=function(){var e=this;Bn(this,d);var t,n=x?B.pageDivs[0]:at(r);if(n){var o=B.scroller[0].scrollLeft,i=B.scroller[0].scrollTop;if((t=ue(n[0],B.scroller[0])).left+=l.x,t.top+=l.y,!c&&t.left>=o&&t.left<=o+B.scroller[0].clientWidth&&t.top>=i&&t.top<=i+B.scroller[0].clientHeight)return void(u&&u())}else(t=ge(x?0:r)).left=t.width+l.x,t.top=t.height+l.y;var a={x:B.scroller[0].clientWidth/2,y:B.scroller[0].clientHeight/2};lt(s,_n.BottomLeft)?(a.x=B.scroller[0].clientWidth,a.y=B.scroller[0].clientHeight):lt(s,_n.TopLeft)&&(a.x=0,a.y=0),U.scrollTarget.Page=r+1,U.scrollTarget.dx=l.x-a.x,U.scrollTarget.dy=l.y-a.y,Ce(t.left-a.x,t.top-a.y,!0,u),setTimeout(function(){Bn(this,e),U.scrollTarget.Page=0,U.scrollTarget.dx=0,U.scrollTarget.dy=0}.bind(this),1e4)}.bind(this);x&&r!==rn()?Ue(r+1,!1,e):e()}function lt(e,t){return e&&t&&e.x===t.x&&e.y===t.y}var st,ct=null;function ut(){ct&&clearTimeout(ct),ct=setTimeout(function(){cn("documentchanged")},200)}function dt(){B.scroller.stop(),B.scroller.pauseEventPropagation(),Qe(),W.tiling&&$e()}function ht(){Ee();var e=x?rn():N.document.getPageCount()-1;0<B.pageDivs.length&&it(e)&&He(B.pageDivs[0]._index),Le(),B.scroller.resumeEventPropagation(),Ke()}function ft(){U.zooming=!0,dt(),cn("zoomstarted")}function gt(e){var t,n,o,i,a,r,l;e=Math.min(e,ae()),e=Math.max(e,ie()),t=e,n=!1,i=ge(q.number,null,null),a=ge(q.number,null,null,t),r=(B.scroller.scrollLeft()-i.width)/W.zoom*t,l=(B.scroller.scrollTop()-i.height)/W.zoom*t,Ce(a.width+r,a.height+l,n,H,o),W.zoom=e,wt(!1),yt(e,!1)}function pt(){U.zooming=!1,ht(),cn({type:"zoomchanged",zoom:W.zoom})}
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function zoom
   */function mt(e,n){var o=this;if(U.zooming)we("zooming",n);else if(U.zooming=!0,dt(),cn("zoomstarted"),e!==W.zoom){e=Math.min(e,ae()),e=Math.max(e,ie());var t=x?0:q.number,i=ge(t,null,null),a=ge(t,null,null,e),r=(B.scroller.scrollLeft()-i.width)/W.zoom*e,l=(B.scroller.scrollTop()-i.height)/W.zoom*e;W.zoom=e,wt(!0,function(){var t=this;Bn(this,o),yt(e,!0,function(){var e=this;Bn(this,t),vt(),Ce(a.width+r,a.height+l,!1,H,function(){Bn(this,e),B.scrollH&&B.scrollH.scrollLeft(B.scroller.scrollLeft()),B.scrollV&&B.scrollV.scrollTop(B.scroller.scrollTop()),null!=n&&n()}.bind(this))}.bind(this))}.bind(this))}else vt(),"function"==typeof n&&n.call()}function vt(){U.zooming=!1,ht(),cn({type:"zoomchanged",zoom:W.zoom})}function bt(e,t){mt(W.zoom+(e?-1:1)*W.zoom*.3,t)}function xt(){B.edges[0]._z=W.zoom}function yt(e,t,n){if(0<B.edges.length){n="function"==typeof n?(s=[xt,n],function(){for(;s.length;){var e=s.shift();e&&e.apply(this,arguments)}}):xt;var o=W.direction===xn.Vertical,i=B.pageDivs[0]&&B.pageDivs[0]._img?B.pageDivs[0]._index:0;x&&(i=0);var a=ge(i,null,null,e),r=o?a.height:a.width;if(t&&!U.loading){var l=o?{height:r}:{width:r};B.edges[0].animate(l,{duration:H,easing:"easeOutQuad",complete:n,queue:!1})}else o?B.edges[0].height(r):B.edges[0].width(r),"function"==typeof n&&n.call();_t()}var s}function _t(u){setTimeout(function(){var e=pn("<canvas/>");u=u||W.zoom;var t=W.direction===xn.Vertical,n=U.newpagedivsize?U.newpagedivsize:{width:q.size.width*u,height:q.size.height*u},o=Math.max(1,W.pagespacing),i=ve();e[0].width=(n.width+o)*(t?i:1),e[0].height=n.height*(t?1:i);var a=e[0].getContext("2d");a.lineWidth=W.pageborderwidth,W.backcolor&&(a.fillStyle=W.backcolor);for(var r=0;r<i;++r){var l=t?1+r*n.width:1,s=t?1:1+r*n.height;a.strokeRect(l,s,n.width-2,n.height-2),W.backcolor&&a.fillRect(l+a.lineWidth,s+a.lineWidth,n.width-2*(1+a.lineWidth),n.height-2*(1+a.lineWidth))}var c={backgroundSize:"auto auto",backgroundRepeat:t?"repeat-y":"repeat-x"};B.edges[0].css(c),B.edges[1].css(c)},0)}function wt(e,t){for(var n=0,o=!0,i=function(){if(--n<=0){if(W.direction===xn.Horizontal){var e=he().width;B.spacer||(B.spacer=X(),B.spacer.css({position:"absolute",top:"-1px",height:"1px"}),B.viewport.append(B.spacer)),B.spacer.width(e)}"function"==typeof t&&t.call(),0===U.prpr&&(vn.Safari||vn.Chrome)&&B.edges[1].hide().show()}},a=0;a<B.pageDivs.length;a++){if(B.pageDivs[a]._img)(B.pageDivs[a]._img.needsZoom()||B.pageDivs[a]._img.needsRotate())&&(o=!1,n++,B.pageDivs[a]._img.needsRotate()?B.pageDivs[a]._img.rotate(i):B.pageDivs[a]._img.needsZoom()&&B.pageDivs[a]._img.zoom(e,i))}o&&i.call()}
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function fit
   */function zt(e,t,n){null!=t?"function"==typeof t&&(n=t,t=q.number):t=q.number;var o=kt(e,t-1),i=o.zoom,a=yn.Width===o.fit&&xn.Vertical===W.direction,r=yn.Height===o.height;a&&Ce(0,null,!1),r&&Ce(null,0,!1),mt(i,n)}function kt(e,t){var n,o,i,a=(n=_e(),o=W.showpageborder?2*W.pageborderwidth:0,i={width:n.width-o,height:n.height-o},W.tabular&&(1<W.columns&&(i.width=Math.floor((n.width-(W.pagespacing+o)*W.columns)/W.columns)),1<W.rows&&(i.height=Math.floor((n.height-(W.pagespacing+o)*W.rows)/W.rows))),i),r=le(t,1,!1);0!==r.width&&0!==r.height||(e=null);var l=W.zoom;switch(e){case yn.None:break;case yn.Best:e=r.width/a.width>r.height/a.height?(l=a.width/r.width,yn.Width):(l=a.height/r.height,yn.Height);break;case yn.Height:l=a.height/r.height;break;case yn.Width:l=a.width/r.width;break;default:l=1,e=yn.None}return{zoom:l,fit:e}}function Pt(e){return W.zoom*N.document.getPageFitMultiplier(e)}function Tt(e){return N.document.getPageRotation(e)}function Dt(e,t){t=t||0;var n=Tt(e),o=Pt(e),i=be(e,t),a=mn.matrix();a.scale(o,o,0,0),a.rotate(n+t,0,0);var r,l,s=(r=a,l={x:i.width,y:i.height},{x:r.x(l.x,l.y),y:r.y(l.x,l.y)}),c=Math.min(0,s.x),u=Math.min(0,s.y),d=a.invert(),h=d.x(-c,-u),f=d.y(-c,-u);return a.translate(h,f),a}function Ct(e){var t=pn.data(e.currentTarget,"_config"),n=pn.data(e.currentTarget,"_annoConfig");!n&&t&&(n={type:t.icon,rotatable:W.showrotatetools}),n&&(N.mouseTool.setTool(bn.None,bn.None),N.annotations.drawAnnotation(n,!1,Et,Mt))}function Mt(){N.mouseTool.setTool(bn.Pan,bn.None)}function Et(){N.mouseTool.setTool(bn.Pan,bn.None)}
/**
   * Checks whether annotations support is enabled.
   * @private
   */function St(){return!1===W.allowannotations&&Z("InitError",'The "allowannotations" property in the WebDocumentViewer config is set to false.'),W.allowannotations}function It(){for(var e=0;e<B.pageDivs.length;e++)B.pageDivs[e]._draw.toFront()}function Ft(){for(var e=0;e<B.pageDivs.length;e++)B.pageDivs[e]._draw.reset()}function At(e,t,n){if(e){if(U.loading=!0,Ze(),q.size.width=e.pagewidth,q.size.height=e.pageheight,q.count=e.pagecount,q.buffer=W.pagebuffersize,q.dpi=e.dpi,q.vector=!0===e.vector,W.allowannotations=n.allowannotations,W.textAnnotationEditorIgnoredKeyCodes=n.textAnnotationEditorIgnoredKeyCodes,W.multiprocessing=n.multiprocessing,W.allowforms=n.allowforms,W.allowtext=n.allowtext,W.tiling=n.tiling,W.documenturl=n.documenturl,W.annotationsurl=n.annotationsurl,W.formsurl=n.formsurl,N.document.__linkChanges(t),N.annotations&&(N.annotations.clear(),N.annotations.loadAnnotations(e)),N.forms&&(N.forms.clear(),e.forms&&N.forms.loadForms(e)),N.text&&B.search&&B.search.ClearSearch(),n.showbookmarks&&(0<N.document.getBookmarks().length?pn("."+zn.atala_tool_button_bookmarks).button("enable"):gn(),s={top:0,left:0,expanded:[]}),U.scrollTarget.Page=0,U.scrollTarget.dx=0,U.scrollTarget.dy=0,U.zooming=!1,e.zoom)W.zoom=e.zoom;else{var o=kt(W.fitting,0);W.zoom=o.zoom}Rt(e.pagenumber||0),N.mouseTool.setTool(W.mousetool.type&&!L?W.mousetool.type:bn.Pan,bn.None),_t(),U.loading=!1,wt(),Y=t.__getSelectedPagesIndices,cn({type:"activedocumentchanged"})}}function Ot(e,t){t&&Qt(!0);for(var n=0;n<e._controllers.document.getPageCount();++n){var o=e._controllers.document.getPageDefinition(n,y);o&&0<=o.cacheIndex&&B.loadedImgs[o.cacheIndex]&&(N.memory.deallocate(B.loadedImgs[o.cacheIndex]),B.loadedImgs[o.cacheIndex].dispose(),B.loadedImgs[o.cacheIndex].remove(),B.loadedImgs[o.cacheIndex]=void 0)}}function Vt(e,o){U.loading=!0;var t={atala_docurl:W.documenturl,atala_pagebuffer:W.pagebuffersize,atala_minwidth:W.minwidth,atala_tiling:W.tiling,atala_bookmarks:W.showbookmarks};L&&(t.atala_thumb=L,t.atala_capt_format=W.thumbcaptionformat),W.tiling&&B.scroller.addClass(zn.atala_page_loading),null!=e&&("function"==typeof e&&(o=e,e=null),pn.extend(t,e)),Yt({type:"docinfo",serverurl:W.serverurl,query:"?ataladocinfo=",method:"GET",data:t,cancel:!1,info:{pagewidth:-1,pageheight:-1,pagecount:-1}},function(e){Lt(e,o)},function(e,t,n){!function(e,t,n,o){if(W.tiling&&B.scroller.removeClass(zn.atala_page_loading),e.responseText){var i=e.responseText.substr(e.responseText.indexOf("</html>")+7);0<=i.indexOf("\x3c!--")?0<(i=i.replace("\x3c!--","").replace("--\x3e","")).length&&(n="<pre>"+i+"</pre>"):0<e.responseText.indexOf("web.config")&&0<e.responseText.indexOf("customErrors")&&(n+=": web.config customErrors attribute has disabled remote error messages.")}Z("DocumentLoadError",n),"function"==typeof o&&o.call(void 0,n)}(e,0,n,o)})}function Lt(n,o){var e,t;(W.tiling&&B.scroller.removeClass(zn.atala_page_loading),n&&!1!==n.licensed)?(n.docurl&&(W.documenturl=n.docurl),n.annourl&&(W.annotationsurl=n.annourl),n.formurl&&(W.formurl=n.formurl),q.size.width=n.pagewidth,q.size.height=n.pageheight,q.count=n.pagecount,q.buffer=W.pagebuffersize,q.dpi=n.dpi,q.vector=!0===n.vector,q.caption=n.thumbcaptionformat||(W.showthumbcaption?"{0}":""),de.zero(),N.memory.clearEntries(),N.memory.colorDepth=n.colordepth,N.memory.pageSize={width:n.pagewidth,height:n.pageheight},cn({type:"documentinfochanged",info:{count:q.count,dpi:q.dpi,size:{height:q.size.height,width:q.size.width},vector:q.vector,pagesizes:n.pagesizes,bookmarks:n.bookmarks},customData:n.customData}),N.text&&(N.text.clear(),B.search&&B.search.ClearSearch(),n.text&&N.text.loadText(n)),U.loading&&(!0===h?W.zoom=1:h=!0,Q(),Ce(0,0),B.scrollV&&B.scrollV.pageNum(1),We(1),zt(W.fitting,1,function(){if(Le(),He(0,B.pageDivs.length-1),x){for(var e=0;e<B.pageDivs.length&&e<q.count;e++)Ye(B.pageDivs[e],null,e);B.content.append(B.pageDivs[0])}else for(var t=0;t<B.pageDivs.length&&t<q.count;t++)B.content.append(B.pageDivs[t]),Ye(B.pageDivs[t],null,t);0<B.pageDivs.length&&B.pageDivs[0].addClass(zn.atala_active_page),n.layers&&n.layers.length?N.annotations.loadAnnotations(n):W.annotationsurl&&N.annotations&&N.annotations.clear(),N.forms&&(N.forms.clear(),n.forms&&N.forms.loadForms(n)),N.mouseTool.setTool(W.mousetool.type&&!L?W.mousetool.type:bn.Pan,bn.None),U.loading=!1,_t(),"function"==typeof o&&o(n.error,n),n.error&&setTimeout(function(){Z("DocumentLoadError",n.error)},0)})),U.loading=!1):(t=n&&!1===n.licensed?(e="LicenseException",n.error?n.error:"LicenseException: Handler was unable to find a valid license."):(e="DocumentLoadError","HandlerException: Handler did not return any data."),U.loading=!1,"function"==typeof o&&o.call(void 0,t),e&&t&&Z(e,t))}function Ht(){Rt()}function Rt(e){if(Q(),0<B.pageDivs.length){var t=N.document.getPageCount(),n="number"==typeof e?e:B.pageDivs[0]._index;n=0<=n?Math.min(n,t-B.pageDivs.length):0;for(var o=0;o<B.pageDivs.length&&o<t;o++){var i=n+o;Xe(B.pageDivs[o]),Ye(B.pageDivs[o],null,i),x&&0<o||B.content.append(B.pageDivs[o])}}if(He(0<B.pageDivs.length?B.pageDivs[0]._index:0,null),Le(),Ut(),Ee(),fe(),x){We((0<B.pageDivs.length?B.pageDivs[0]._index:0)+1)}else{var a=ce(B.scroller[0].scrollLeft,B.scroller[0].scrollTop);We(a+1),0<=e&&a!==e&&Ne(e)}}function jt(e,t){var n={atala_docurl:W.documenturl,atala_spath:W.savepath};function o(e){!function(e){e.error?Z("DocumentSaveError",e.error):Pe("DocumentSave: success="+e.success);cn({type:"documentsaved",success:e.success,customData:e.customData,fileName:e.fileName})}(e),"function"==typeof t&&t.call()}pn.extend(n,e),Yt({type:"docsave",serverurl:W.serverurl,query:"?ataladocsave=",method:"POST",data:n,cancel:!1,info:{success:void 0,error:void 0}},o,function(e){var t=[];t.error=e.responseText,o(t)})}function Bt(e,t,n){var o=null;return"string"==typeof e?(o={},U.initialized&&n&&(0<e.length?(n.clear(),o=n.createHandlerRequest(W.serverurl,e,t)):0===e.length&&n.clear()),o.url=e):void 0!==e&&null!=e&&Z("openUrlError","string input expected for url."),o}function Nt(){ln({annotationsloaded:Xt})}function qt(){ln({formsloaded:Gt})}function Ut(e){if(!(0<B.pageDivs.length&&void 0===B.pageDivs[0]._index))for(var t=0;t<B.pageDivs.length;t++)Zt(B.pageDivs[t],e)}function Wt(e,t){var n=at(e);n&&Zt(n,t)}function Zt(e,t){(Ye(e,ot(e._index),e._index)||t)&&(N.annotations&&N.annotations.showLayer(e._index,e),N.forms&&!L&&N.forms.showLayer(e._index,e),N.text&&!L&&W.allowtext&&N.text.showLayer(e._index,e))}function Xt(e){e.error&&(Z("AnnotationsLoadError",e.error),W.annotationsurl=""),N.annotations&&sn({annotationsloaded:Xt})}function Gt(e){e.error&&(Z("FormsLoadError",e.error),W.formsurl=""),N.forms&&sn({formsloaded:Gt})}function Yt(o,t,i,n){var a,r,e,l=this,s=(a=o,r=function(e){t(e.request.info)},ln({handlerreturned:e=function e(t){t.request===a&&(sn({handlerreturned:e}),"function"==typeof r&&r.call(this,t))}}),e);if(cn({type:"beforehandlerrequest",request:o}),!o.cancel&&(sn({handlerreturned:s}),o.serverurl&&!pn.isEmptyObject(o.data))){if(!(o.info instanceof pn&&"docpage"===o.type)){if("fileupload"!==o.type)return pn.ajax({type:o.method,url:o.serverurl+o.query+"?",dataType:"json",data:o.data,success:t,error:i,crossDomain:("string"!=typeof o.method||"post"!==o.method.toLowerCase())&&void 0});var c="&"+pn.param(o.data),u=new FormData;u.append("file",o.file,o.file.name);var d=pn.ajax({type:o.method,url:o.serverurl+o.query+"??"+c,dataType:"json",data:u,contentType:!1,processData:!1,success:function(e){Bn(this,l),e.success&&(e.success=JSON.parse(e.success)),e.canceled&&(e.canceled=JSON.parse(e.canceled)),t(e,o.file.name)}.bind(this),error:function(e,t,n){Bn(this,l),i(t,n,o.file.name)}.bind(this),crossDomain:("string"!=typeof o.method||"post"!==o.method.toLowerCase())&&void 0,xhr:function(){var t=this;Bn(this,l);var e=new XMLHttpRequest;return e.upload.addEventListener("progress",function(e){Bn(this,t),e.lengthComputable&&(n(o.file.name,e.loaded,e.total)||d.abort())}.bind(this),!1),e}.bind(this)});return d}o.info.attr("src",o.serverurl+o.query+"&"+pn.param(o.data))}}
/**
   ...
   * @function empty
   */
function Jt(e){U.loading=!0;Qt(),Lt({pagewidth:0,pageheight:0,pagecount:-1},function(){Ee(),cn({type:"documentunloaded"}),"function"==typeof e&&e.call()})}function Qt(e){var t;U.initialized&&(Ze(),Q(0),e||function(){for(var e=0;e<B.loadedImgs.length;e++)B.loadedImgs[e]&&(B.loadedImgs[e].dispose(),B.loadedImgs[e].remove());B.loadedImgs.length=0}(),B.edges[0].width(0).height(0),B.edges[1].width(0).height(0),B.scrollH&&(B.scrollH.scrollSize(0),Fe(B.scrollH)),B.scrollV&&(B.scrollV.scrollSize(0),Fe(B.scrollV)),x&&We(1),t={backgroundImage:"",backgroundSize:"",backgroundRepeat:"",backgroundColor:""},B.edges[0].css(t),B.edges[1].css(t))}
/**
...
/**
   ...
   * @returns {boolean}
   */
function Kt(){return U.initialized}
/**
...
/**
   ...
   * @function next
   */
function $t(e,t){var n=W.direction===xn.Vertical?ve():1;null==t&&"function"==typeof e&&(t=e,e=n),isFinite(e)||(e=n),Me(e,t)}
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function previous
   */function en(e,t){var n=W.direction===xn.Vertical?ve():1;null==t&&"function"==typeof e&&(t=e,e=n),isFinite(e)||(e=n),Me(-e,t)}
/**
   * Zooms in one level.
...
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function openUrl
   */function on(e,t,n,o){null==o&&("function"==typeof t?(o=t,t=null):"function"==typeof n&&(o=n,n=null));var i=0,a=!1,r=Bt(t,e,N.annotations),l=Bt(n||e,e,N.forms);W.annotationsurl=r?r.url:W.annotationsurl,W.formsurl=l?l.url:W.formsurl;var s,c,u,d,h=function(e,t){--i<=0&&(Ut(!0),cn({type:"documentloaded",customData:null==t?void 0:t.customData}),"function"==typeof o&&o.call(void 0,e,t))};if("string"==typeof e){if(0===e.length)Jt(h);else if(W.documenturl=e,U.initialized){Qt(),ee(B.scrollH),ee(B.scrollV),i++;var f={};W.allowannotations&&r&&r.data&&(Nt(),pn.extend(f,r.data)),W.allowforms&&l&&l.data&&(qt(),pn.extend(f,l.data)),a=!0,Vt(f,h)}}else!(e||!(0<W.documenturl.length)||!t&&""!==t&&!n&&""!==n)||Z("openUrlError","string input expected for document url.");a||(r&&(i++,u=r,d=h,N.annotations&&(Nt(),N.annotations.makeHandlerRequest(u,d))),l&&(i++,s=l,c=h,N.forms&&(qt(),N.forms.makeHandlerRequest(s,c))))}
/**
   ...
   * _viewer.save(‘’, ‘tif’)
   */function an(e,t,n,o){"function"==typeof n&&(o=n,n={}),"function"==typeof t&&(o=t,t=W.savefileformat),"function"==typeof e&&(o=e,e=null),void 0===t&&(t=W.savefileformat);var i=pn.extend(!0,n,{atala_subpath:e||"",atala_sformat:t});N.annotations&&pn.extend(i,{atala_iuname:W.annotations.saveusername,atala_annos:N.annotations.stringifyChanges()}),N.forms&&pn.extend(i,{atala_forms:N.forms.stringifyChanges()}),N.document&&pn.extend(i,{atala_document:N.document.stringifyChanges()}),W.savepreviouslysigneddocument&&pn.extend(i,{atala_savesigned:"true"}),jt(i,o)}
/**
...
/**
   ...
   * @returns debug info object if available, otherwise null
   */
return c.__getDebugInfo=function(){var e={version:In.join(".")};W.debug&&pn.extend(!0,e,{dom:B,controllers:N,page:q});return e}
/**
...
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function scrollBy
   */,c.scrollBy=function(e,t,n,o){null==o&&"function"==typeof n&&(o=n,n=!1);i=e,a=t,r=n,l=null,s=o,Ce(B.scroller.scrollLeft()+i,B.scroller.scrollTop()+a,r,l,s);var i,a,r,l,s},c.next=x?Be:$t,c.previous=x?je:en,c.zoom=mt,c.zoomIn=tn,c.zoomOut=nn,c.openUrl=c.OpenUrl=on,c.save=an,c.uploadFiles=
/**
...
/**
   ...
   */,c.reloadPage=function(o,e,t,n,i){var a=pn.Deferred(),r=pn.Deferred(),l=pn.Deferred(),s=pn.Deferred();"function"==typeof n&&(i=n,n=void 0),"function"==typeof t&&(i=t,t=!1),"function"==typeof e&&(i=e,e=!1),"function"==typeof i&&a.done(i);var c=N.document.getPageDefinition(o);if(!c)return a.resolve(),a.promise();0<=c.cacheIndex&&B.loadedImgs[c.cacheIndex]?s=nt(c,n):ot(o,n,function(){s.resolve()});var u="string"==typeof e?e:c.uri?null:W.annotationsurl;W.allowannotations&&e&&(u||c.uri)?N.annotations.loadAnnotationsUrl(W.serverurl,u,c.uri,c.index,1,o,function(){r.resolve(!0)}):(e&&N.annotations.loadAnnotations({layers:[[]],offset:o}),r.resolve(!!e));var d="string"==typeof t?t:c.uri?null:W.formsurl;return W.allowforms&&t&&(W.formsurl||d)?N.forms.loadFormUrl(W.serverurl,d,c.uri,c.index,1,o,function(){l.resolve(!0)}):l.resolve(),pn.when(s,r,l).done(function(e,t,n){(t||n)&&Wt(o,!0),a.resolve(o)}),a.promise()},c.showPage=Ne,c.showPageNumber=qe,An(),Ln(),On(),Hn(),c.annotations=An.__exposedApi,c.document=Ln.__exposedApi,c.forms=On.__exposedApi,c.text=Hn.__exposedApi,function(){Kt()||(U={prpr:0,batchoperation:0,loading:(q={size:{width:0,height:0},sizes:[{width:0,height:0}],smallest:{width:0,height:0},count:0,number:-1,numberoutof:-1,buffer:3,dpi:96,vector:!1,caption:"",customData:null},!1),zooming:!1,initialized:!1,newpagedivsize:null,newpagedivfullzoom:1,scrollPos:{x:0,y:0,t:0},scrollBuffer:null,scrollTimeout:null,activepage:null,nextImageCacheIndex:0,scrollTarget:{Page:0,dx:0,dy:0},hidden:!1,itch:!1,tilingCorrelationId:0});var e={_config:W,_id:y,_dom:B,_document:B.loadedImgs,_pages:B.pageDivs,_state:U,_internalEvents:r,_controllers:N,createDOM:P,createDiv:X,createDialog:M,createDropDownButton:E,createDropDownMenu:S,createMenu:C,drawAnnotation:Ct,redrawVisiblePages:Ut,adjustVisiblePages:wt,startDomManipulation:dt,endDomManipulation:ht,redrawPageFromIndex:Wt,makeHandlerRequest:Yt,getPageScale:Pt,getPageSize:xe,getSourcePageSize:be,getPageRotation:Tt,getViewerTransform:Dt,isPageInView:it,findPageFromIndex:at,showPagePoint:rt,disableBookmarkButton:gn,throwError:Z,triggerEvent:cn};N.document=new Ln(c,e,y),c.document=N.document.__exposedApi,W.allowannotations?(N.annotations=new An(c,e,L),c.annotations=N.annotations.__exposedApi):(c.deselectAll=St,c.createAnnotationOnPage=St,c.getAnnotationsFromPage=St,c.deleteAnnotationOnPageAtIndex=St,c.setAnnotationDefaults=St,c.setImages=St,c.setStamps=St),W.allowforms&&!N.forms&&(N.forms=new On(c,e),c.forms=N.forms.__exposedApi),W.allowtext&&(N.text=new Hn(c,e,W.mousetool?W.mousetool.text:{}),c.text=N.text.__exposedApi),N.upload=new Vn(c,e),!1===U.initialized&&(U.initialized=!0,ln({throwerror:k,pagedivsresized:p,documentchanged:Ht,pagesizechanged:m}),W.parent?(W.parent instanceof pn||(W.parent=pn(W.parent)),W.parent.length||Z("InitError","Parent element not found.")):Z("InitError","No parent element given."),B.toolbar=(t=W.toolbarparent||W.parent,(n=function(e){var t=this,n={id:y+"_toolbar",parent:e,children:[{type:"button",id:"Button_PagePrev",cls:zn.atala_tool_button_page_prev,icon:"page-prev",tooltip:"Previous Page",text:null,onclick:function(){x?je():en()}},{type:"pagelabel",id:"Label_PageNumber",cls:zn.atala_page_label},{type:"button",id:"Button_PageNext",cls:zn.atala_tool_button_page_next,icon:"page-next",tooltip:"Next Page",text:null,onclick:function(){x?Be():$t()}},{type:"button",id:"Button_ZoomOut",cls:zn.atala_tool_button_zoom_out,icon:"zoom-out",tooltip:"Zoom Out",text:"",onclick:function(){nn()}},{type:"button",id:"Button_ZoomIn",cls:zn.atala_tool_button_zoom_in,icon:"zoom-in",tooltip:"Zoom In",text:"",onclick:function(){tn()}},{type:"button",id:"Button_FitNone",cls:zn.atala_tool_button_fit_none,icon:"zoom-full",tooltip:"Full Size",text:"",onclick:function(){mt(1)}},{type:"button",id:"Button_FitBest",cls:zn.atala_tool_button_fit_best,icon:"fit-best",tooltip:"Best Fit",text:"",onclick:function(){zt(yn.Best)}},{type:"button",id:"Button_FitWidth",cls:zn.atala_tool_button_fit_width,icon:"fit-width",tooltip:"Fit To Width",text:"",onclick:function(){zt(yn.Width)}}]};return W.showselecttools&&n.children.splice(5,0,{type:"button",id:"Button_ZoomArea",cls:zn.atala_tool_button_zoom_area,icon:"zoom-area",tooltip:"Zoom Area",text:"",onclick:V}),W.allowtext&&(n.children.splice(3,0,{type:"button",id:"Button_Text",cls:zn.atala_tool_button_text_tool,icon:"text-tool",tooltip:"Text Selection",text:"",onclick:function(){N.mouseTool.setTool(bn.Text)}}),n.children.splice(3,0,{type:"button",id:"Button_Pan",cls:zn.atala_tool_button_pan_tool,icon:"pan-tool",tooltip:"Pan",text:"",onclick:function(){N.mouseTool.setTool(bn.Pan)}})),W.showrotatetools&&(n.children.push({type:"button",id:"Button_RotateLeft",cls:zn.atala_tool_button_rotate_left,icon:"rotate-left",tooltip:"Rotate Left",text:"",onclick:G(270)}),n.children.push({type:"button",id:"Button_RotateRight",cls:zn.atala_tool_button_rotate_right,icon:"rotate-right",tooltip:"Rotate Right",text:"",onclick:G(90)})),0<W.savepath.length&&n.children.unshift({type:"button",id:"Button_Save",cls:zn.atala_tool_button_save,icon:"save",tooltip:"Save Changes",text:null,onclick:function(){an()}}),!1!==W.upload.enabled&&n.children.unshift({type:"button",id:"Button_Upload",cls:zn.atala_tool_button_upload,icon:"upload",tooltip:"Upload document",text:null,onclick:function(){!function(){var t=this;L||N.upload.uploadWithUi(function(e){Bn(this,t),e?(B.toolbar.controlgroup("enable"),W.allowannotations&&B.toolbar.annoToolbar.controlgroup("enable"),B.toolbar.find(".atala_page_label, .atala_search_container").removeClass("ui-state-disabled")):(B.toolbar.controlgroup("disable"),B.toolbar.annoToolbar&&B.toolbar.annoToolbar.controlgroup("disable"),B.toolbar.find(".atala_page_label, .atala_search_container").addClass("ui-state-disabled"))}.bind(this))}()}}),!1!==W.showbookmarks&&n.children.unshift({type:"button",id:"Button_Bookmarks",cls:zn.atala_tool_button_bookmarks,icon:"bookmarks",tooltip:"Show bookmarks",text:null,onclick:function(){!function(){var t=this;if(!L){var e=y+"_"+zn.atala_bookmark_content,n="#"+e;if(0<pn(n).length)return fn(),pn(n).remove(),hn();var o,i=N.document.getBookmarks();if(0<i.length){var a=.85*B.main.height();st=0,W.allowtext&&W.mousetool.text.allowsearch||pn("<div/>").css("clear","both").appendTo(B.toolbar);var r=pn("<div/>").addClass("ui-widget").addClass(zn.atala_bookmark_content).css("max-height",a+"px").attr("id",e).appendTo(B.toolbar),l=pn("<ul></ul>");pn('<span id = "atala_bkm_header" class ="'+zn.atala_bookmark_header+'">Bookmarks</span>').appendTo(l),vn.Chrome&&l.attr("aria-labelledby","atala_bkm_header"),l.appendTo(r),i.forEach(function(e){return Bn(this,t),function t(e,n){var o=this;if(0<e.Children.length){var i=pn('<li><span class="atala-bookmark-caret"></span></li>'),a=pn("<a>"+e.Text+"</a>");if(vn.Chrome){var r=h();a.attr("id",r),i.attr("aria-labelledby",r)}a.click(function(){N.document.scrollToBookmark(e)}),a.appendTo(i);var l=pn('<ul class = "atala-bookmark-nested"></ul>').attr("id","expandable_bookmark_"+e.id);l.appendTo(i),i.find("span").click(function(){this.parentElement.querySelector(".atala-bookmark-nested").classList.toggle("atala-bookmark-active"),this.classList.toggle("atala-bookmark-caret-down")}),i.appendTo(n);var s=N.document.getChildBookmarks(e);s.forEach(function(e){return Bn(this,o),t(e,l)}.bind(this))}else{var c=pn("<li></li>"),u=pn("<a>"+e.Text+"</a>");if(vn.Chrome){var d=h();u.attr("id",d),c.attr("aria-labelledby",d)}u.click(function(){N.document.scrollToBookmark(e)}),u.appendTo(c),c.appendTo(n)}function h(){return"bkm_"+ ++st}}(e,l)}.bind(this)),r.contextmenu(function(){return!1}),r.show(),o="#"+zn.atala_bookmark_content+y,s.expanded.forEach(function(e){var t=pn("#"+e);t.toggleClass("atala-bookmark-active"),t.parent().children(".atala-bookmark-caret").toggleClass("atala-bookmark-caret-down")}),pn(o).scrollTop(s.top),pn(o).scrollLeft(s.left),setTimeout(function(){document.addEventListener("click",un)},50),pn(document).one("viewportclick",dn)}}}()}}),W.toolbarbuttons&&W.toolbarbuttons.reverse().forEach(function(e){Bn(this,t),n.children.unshift({type:"button",id:e.id,cls:e.class,tooltip:e.tooltip,onclick:e.onclick,text:null,icon:e.icon,custom:!0})}.bind(this)),D(n)}(t)).controlgroup(),W.allowannotations&&(n.annoToolbar=D({id:y+"_toolbar",parent:t,children:[{type:"button",id:"Button_Ellipse",cls:zn.atala_tool_button_ellipse_anno,icon:"ellipse",tooltip:"Draw Ellipse",text:"",onclick:Ct},{type:"button",id:"Button_Highlight",cls:zn.atala_tool_button_highlight_anno,icon:"highlight",tooltip:"Draw Highlight",text:"",onclick:Ct},{type:"button",id:"Button_Line",cls:zn.atala_tool_button_line_anno,icon:"line",tooltip:"Draw Line",text:"",onclick:Ct},{type:"button",id:"Button_Lines",cls:zn.atala_tool_button_lines_anno,icon:"lines",tooltip:"Draw Poly Lines",text:"",onclick:Ct},{type:"button",id:"Button_Freehand",cls:zn.atala_tool_button_freehand_anno,icon:"freehand",tooltip:"Draw Freehand",text:"",onclick:Ct},{type:"button",id:"Button_Polygon",cls:zn.atala_tool_button_polygon_anno,icon:"polygon",tooltip:"Draw Polygon",text:"",onclick:Ct},{type:"button",id:"Button_Rectangle",cls:zn.atala_tool_button_rect_anno,icon:"rectangle",tooltip:"Draw Rectangle",text:"",onclick:Ct},{type:"button",id:"Button_Text_Anno",cls:zn.atala_tool_button_text_anno,icon:"text",tooltip:"Draw Text",text:"",onclick:Ct}]}),n.annoToolbar.addClass(zn.atala_annotation_toolbar),n.annoToolbar.controlgroup()),W.showstatus&&(B.status=pn('<div id="'+y+'_status"></div>'),B.status.addClass(zn.atala_statusbar),B.status.css("display","inline"),n.append("Status:"),n.append(B.status)),W.allowtext&&W.mousetool.text.allowsearch&&(B.search=new O({parent:n})),n),B.toolbar.addClass(zn.atala_toolbar),B.main=X(W.parent),B.main.addClass(zn.atala_main_container),B.scroller=X(B.main),B.scroller.addClass(zn.atala_scroller),B.main.on({selectstart:w}),B.toolbar.attr("id",y+"_toolbar"),B.main.attr("id",y+"_main"),B.scroller.attr("id",y+"_scroller"),B.main.css({height:"100%",width:"100%",position:"relative"}),B.scroller.css({height:"100%",width:"100%",position:"relative"}),B.viewport=X(B.scroller,y+"_vp"),B.viewport.css({overflow:"hidden",fontSize:0,"touch-action":"none"}),B.viewport.addClass(zn.atala_viewport),B.viewport.attr("tabindex",-1),B.edges[0]=J(B.viewport,y+"_e0"),B.edges[0].addClass(zn.atala_dom_edge_first),B.content=X(B.viewport,y+"_ct"),B.content.addClass(zn.atala_content),B.content.attr("tabindex",-1),B.content.attr("role","figure"),vn.Explorer&&B.content.attr("aria-label",L?"Thumbnailer":"Viewer"),B.content.css({"-ms-touch-action":"none",fontSize:0,overflow:"hidden"}),W.direction===xn.Horizontal&&B.content.css({display:"inline-block"}),B.edges[1]=J(B.viewport,y+"_e1"),B.edges[1].addClass(zn.atala_dom_edge_last),vn.Features.Compatibility&&Z("InitError","Compatibility Mode is not supported."),!1===W.upload.enabled||L||(B.uploadCtrl=N.upload.getUploadControl()),vn.Mobile.Any()?B.scroller.css({overflow:"hidden"}):W.showscrollbars?(x?B.scroller.css({overflow:"scroll"}):B.scroller.css({overflow:"auto"}),B.scrollH=$(B.main,xn.Horizontal),B.scrollH.attr("id",y+"_sH"),B.scrollH.addClass(zn.atala_scroll_horizontal),B.scrollH.attr("role","scrollbar"),B.scrollH.attr("aria-controls",y+"_scroller"),B.scrollH.attr("aria-orientation","horizontal"),B.scrollH.attr("aria-valuemin","0"),B.scrollH.attr("aria-valuemax","1"),B.scrollH.attr("aria-valuenow","0"),B.scrollV=$(B.main,xn.Vertical),B.scrollV.attr("id",y+"_sV"),B.scrollV.addClass(zn.atala_scroll_vertical),B.scrollV.attr("role","scrollbar"),B.scrollV.attr("aria-controls",y+"_scroller"),B.scrollV.attr("aria-orientation","vertical"),B.scrollV.attr("aria-valuemin","0"),B.scrollV.attr("aria-valuemax","1"),B.scrollV.attr("aria-valuenow","0")):B.scroller.css({overflow:"hidden"}),N.mouseTool=new Rn(c,{_internalEvents:r,_controllers:N,zoomStart:ft,zoom:gt,zoomEnd:pt,getActivePage:Re,raiseDrawLayer:It,resetDrawLayer:Ft,getViewerTransform:Dt},B.viewport,B.scroller,pn.extend({allowflick:W.allowflick},W.mousetool)),N.memory=new Sn({highWaterMark:W.memorythreshold}),N.memory.bind({exceededhighwatermark:g}),N.annotations&&N.annotations.setViewPort(B.viewport),cn("initialized"),W.direction===xn.Horizontal&&B.viewport.css({"white-space":"nowrap"}),B.viewport.css({display:"table-cell"}),te(B.scroller),B.scrollH&&B.edges[1].height(B.scrollH.scrollbarHeight()),N.mouseTool.setTool(bn.Pan,bn.None),(W.documenturl||W.annotationsurl||W.formurl)&&on(W.documenturl,W.annotationsurl,W.formurl,o),pn(b));var t,n}(),c};n(125);function $e(e,t){if(e!==t)throw new TypeError("Cannot instantiate an arrow function")}
/**
...
/** Triggers after thumbnail drag & drop operation is complete.
     ...
     * @param {ThumbDragCompleteEventArgs} args - The event data.
     */
thumbdragcomplete:null};function P(){return{get:function(){return h},detachViewer:M,activateViewer:C}}function T(e,t){if(e){var n=t?e.bind:e.unbind,o=t?h.unbind:h.bind;n.call(e,{beforehandlerrequest:Pe,documentloaded:fe,scroll:xe,pagerotated:ze,pageinserted:pe,pageremoved:ve,pagemoved:be}),o.call(h,{pagerotated:ge,pageinserted:ge,pageremoved:ge,pagemoved:ge}),a(e,e.document.events,n),k.allowannotations&&(n.call(e,{annotationresized:ke,annotationmoved:ke,annotationrotated:ke,annotationchanged:ke,annotationcreated:_e,annotationdeleted:we}),e.annotations&&a(e,e.annotations.events,n))}}function a(e,t,n){var o={};for(var i in t)t.hasOwnProperty(i)&&(o[i]=r);n.call(e,o)}function r(){h.trigger.apply(h,arguments)}
/**
...
/** 
   ...
   */function W(e,t){if(null!==(e=Qe(e))&&(void 0===t||"function"==typeof t||null===t)){var n=g.indexOf(e);-1!==n&&1!==g.length&&(g.splice(n,1),Z(),h.trigger({type:"thumbdeselected",index:e}),"function"==typeof t&&t())}}function Z(){var e=V();if(y?(w.viewer.pagenumber=e[0],C(f,h.getDocumentInfo())):q(!0),!(1<g.length)&&f){var t=f.getCurrentPageIndex(),n=e[0];0<=t&&n!==t&&(w.scrolling=!0,f.showPage(n,ye))}}
/**
