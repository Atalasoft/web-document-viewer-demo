...
/**
     ...
     * @private
     */
Upload:Atalasoft.Upload||{}},Atalasoft.Controls.Version=[11,1,0,336];var _Statics={instanceCounter:0};
/**
...
c.domclasses=S,
/** WARNING: Changing values from these references can cause instability.*/
c.domattributes=h;var dt={height:0,isEmpty:function(){return 0===this.width&&0===this.height},width:0,zero:function(){this.width=0,this.height=0},zoom:1};function ht(){if(dt.isEmpty()||dt.zoom!==E.zoom){var t=gt(null,null,null,E.zoom);dt.height=t.height,dt.width=t.width,dt.zoom=E.zoom}return dt}function gt(t,e,o,n){return pt(0,t,e,o,n)}function pt(t,e,o,n,i){if(E.tabular)return function(t,e,o,n,i){if(e<t)return{width:0,height:0,index:e};var a=ft(t,o,n,i),l=ft(e,o,n,i);return l.height=E.direction===V.Vertical?l.height-a.height:l.height,l.width=E.direction===V.Horizontal?l.width-a.width:l.width,l}(t,e,o,n,i);var a=M.document.getPageCount();e=e||0===e?e:a;var l={height:0,width:0,index:t=t||0};if(E.direction===V.Vertical)for(var r=null,s=t;s<a&&s<e&&(l.height+(r=lt(s,i).height)<=n||null==n);s++)l.height+=r+E.pagespacing,l.index++;else if(E.direction===V.Horizontal)for(var c=null,u=t;u<a&&u<e&&(l.width+(c=lt(u,i).width)<=o||null==o);u++)l.width+=c+E.pagespacing,l.index++;return l.index>=a&&0<a&&(l.index=a-1),l}function ft(t,e,o,n){var i=M.document.getPageCount(),a={height:0,width:0,index:0},l=mt(n);t=null==t?t=i:t;var r=void 0,s=void 0;E.direction===V.Vertical?(r=l||1,s=Math.ceil(i/r)):E.direction===V.Horizontal&&(s=l||1,r=Math.ceil(i/s));var c=lt(0,n);c.width+=E.pagespacing,c.height+=E.pagespacing;var u=null==o?Math.floor(t/r):Math.floor(o/c.height),d=null==e?t%r:Math.ceil(e/c.width);return a.height=u*c.height,a.width=d*c.width,a.index=u*r+d,a.index>=i&&0<i&&(a.index=i-1),a}function mt(t){var e=1;if(E.tabular){var o=E.pagespacing||0,n=lt(0,t);E.direction===V.Vertical?(e=Math.floor(b.content.width()/n.width),e=Math.min(e,Math.floor((b.content.width()-e*o)/n.width))):E.direction===V.Horizontal&&(e=Math.floor(b.content.height()/n.height),e=Math.min(e,Math.floor((b.content.height()-e*o)/n.height)))}return e||1}function _t(t,e){var o=vt(t);return(we(t)+(e||0))%180==0?o:{width:o.height,height:o.width}}function vt(t){var e=M.document.getPageSize(t);return e||I.size}function wt(){return{width:b.scrollV?b.main.width()-b.scrollV.width():b.main.width(),height:b.scrollH?b.main.height()-b.scrollH.scrollbarHeight():b.main.height()}}function bt(t,e){var o={status:"fail",started:!1,reason:t};return"function"==typeof e&&e.call(),o}function xt(t,e,o,n,i,a){var l=ut(t,e);return l.left<=i&&l.left+t.clientWidth>=o&&l.top<=a&&l.top+t.clientHeight>=n}function yt(t,e,o){return e<t.length&&(t.splice(o,0,t.splice(e,1)[0]),!0)}function zt(t){E.showstatus&&b.status&&b.status.html(t),eo({type:"statusmessage",message:t})}function Dt(t,e){var o=void 0;if(1===t.length&&"object"===_typeof(t[0]))o=t[0];else if("string"==typeof t[0]){o={};var n=null;3===t.length?n=t[2]:2===t.length&&(n=t[1]);for(var i=-1<t[0].indexOf(" ")?t[0].split(" "):[t[0]],a=0;a<i.length;a++)o[i[a]]=n}for(var l in o)if(o.hasOwnProperty(l)){var r=null;if(l in g?r=g:c&&l in c.annotations.events?r=c.annotations.events:c&&l in c.forms.events?r=c.forms.events:c&&l in c.document.events&&(r=c.document.events),null==r&&(r=g),null==r[l])e&&(r[l]=[o[l]]);else if(e)r[l].push(o[l]);else if(o[l])for(var s=0;s<r[l].length;s++)r[l][s]===o[l]&&r[l].splice(s,1);else r[l].length=0}}function Tt(t,e){return e?isFinite(parseFloat(t)):isFinite(parseInt(t,10))}function Pt(t,e,o,n,i){if(null==i&&"function"==typeof n&&(i=n,n=null),t=null==t?b.scroller.scrollLeft():t,e=null==e?b.scroller.scrollTop():e,E.direction===V.Horizontal){if(t>b.viewport.width()){var a=ht();if(t<a.width&&0<b.content.width()){var l=a.width-(b.edges[0].width()+b.content.width());b.edges[1].width(l)}}}else if(E.direction===V.Vertical&&e>b.viewport.height()){var r=ht();if(e<r.height&&0<b.content.height()){var s=r.height-(b.edges[0].height()+b.content.height());b.edges[1].height(s)}}b.scroller.stop(),!o||k.loading||k.scrollPos.x===t&&k.scrollPos.y===e?(b.scroller.scrollLeft(t),b.scroller.scrollTop(e),"function"==typeof i&&i.call()):C.when(b.scroller.animate({scrollLeft:t,scrollTop:e},{duration:n||u,easing:"easeOutQuad",queue:!1})).done(i)}function Ct(t,e){if(b.scroller.is(":animated"))return bt("scrolling",e);var o=gt(I.number+t-1);Pt(o.width,o.height,!0,e)}function At(){if(b.scrollH&&b.scrollV){var t=M.document.getPageCount();if(b.scrollH.pauseEventPropagation(),b.scrollV.pauseEventPropagation(),E.direction===V.Vertical){Ht(b.scrollH,"width");var e=Math.round(gt(t-1).height+lt(t-1).height);Atalasoft.Utils.Browser.Firefox&&(e+=Math.round(b.scrollH.scrollbarHeight())),b.scrollV.scrollSize(e-(b.scrollV.height()-b.scrollH.scrollbarHeight()-1)),3e4<e?(b.scrollV.ratio(e/(3e4-(b.scrollV.height()-b.scrollH.scrollbarHeight()-1))),b.scrollV._tray.height(3e4)):(b.scrollV._tray.height(e),b.scrollV.ratio(1)),Mt(b.scrollV)}else if(E.direction===V.Horizontal){Ht(b.scrollV,"height");var o=Math.round(gt(t-1).width+lt(t-1).width);b.scrollH.scrollSize(o),3e4<o?(b.scrollH.ratio(o/(3e4-(b.scrollH.width()-b.scrollV.width()-1))),b.scrollH._tray.width(3e4)):(b.scrollH._tray.width(o),b.scrollH.ratio(1)),Mt(b.scrollH)}b.scrollV._max=Math.max(b.scrollV._tray.height()-b.scrollV.height(),0)+1,b.scrollH._max=Math.max(b.scrollH._tray.width()-b.scrollH.width(),0)+1,b.scrollH.resumeEventPropagation(),b.scrollV.resumeEventPropagation()}}function Ht(t,e){if(t){var o=Math.round(I.size[e]*E.zoom);if(E.tabular)o=b.content[e]();else for(var n=0;n<b.pageDivs.length;n++)null!=b.pageDivs[n]._index&&(o=Math.max(lt(b.pageDivs[n]._index)[e],o));t._tray[e](o),t.scrollSize(o-t[e]()),Mt(t),t.ratio(1)}}function Mt(t){t&&(t._scrollSize<=0?t._tray.hide():t._tray.show())}function Vt(t){if(!k.zooming&&!k.scrollBuffer&&b.pageDivs.length){var e=(new Date).getTime(),a=b.scroller[0].scrollLeft,l=b.scroller[0].scrollTop,o=a+b.scroller[0].clientWidth,n=l+b.scroller[0].clientHeight,i=st(a,l)+1,r=Math.abs(i-I.number)/mt();if(!k.loading){var s=M.document.getPageCount(),c=b.pageDivs[0]._index,u=b.pageDivs[b.pageDivs.length-1]._index,d=0===r&&(I.number-1<c||I.number-1>u);r<b.pageDivs.length&&!d?xt(b.edges[1][0],b.scroller[0],a,l,o,n)&&u<s-1?Ft(r):xt(b.edges[0][0],b.scroller[0],a,l,o,n)&&0<c?Lt(r):i!==I.number&&null===Yt(i-1)&&Bt(i):Wt(i,!1,null),fe()}if(Rt(ct(a,l)+1),!b.scroller.propagationPaused()&&b.scrollH&&b.scrollV){var h=Math.round(a/b.scrollH._ratio),g=Math.round(l/b.scrollV._ratio);h!==b.scrollH.scrollLeft()&&(b.scrollH.pauseEventPropagation(!0),b.scrollH.scrollLeft(h)),g!==b.scrollV.scrollTop()&&(b.scrollV.pauseEventPropagation(!0),b.scrollV.scrollTop(g))}eo({type:"scroll",x:a,y:l,dx:a-k.scrollPos.x,dy:l-k.scrollPos.y}),t&&(k.scrollTimeout&&clearTimeout(k.scrollTimeout),k.scrollTimeout=setTimeout(function(){var t,e,o,n,i;t=a,e=l,o=b.scroller[0].scrollLeft,n=b.scroller[0].scrollTop,i=o===k.scrollPos.x&&n===k.scrollPos.y,t===k.scrollPos.x&&e===k.scrollPos.y&&i?(Fe(),k.scrollTimeout=null,k.loading||fe()):i||(Vt({}),k.scrollTimeout=null)},500),k.scrollPos.x=b.scroller[0].scrollLeft,k.scrollPos.y=b.scroller[0].scrollTop,k.scrollPos.t=e),k.scrollBuffer=t?setTimeout(It,50):null}}function It(){null!==k.scrollBuffer&&(clearTimeout(k.scrollBuffer),k.scrollBuffer=null)}function kt(){if(E.direction===V.Horizontal){var t=b.pageDivs.length?(A?Math.max(I.size.height,I.size.width):I.size.height)*E.zoom:0;E.thumbpadding&&"number"==typeof E.thumbpadding&&(t+=2*E.thumbpadding),b.edges[0].height(t),b.edges[1].height(t)}}function St(t,e){e=e||0===e?e:t+b.pageDivs.length-1,e=Math.max(t,e);var o=E.tabular?mt():1,n=E.tabular?(Math.floor(e/o)+1)*o-e:1,i=gt(t),a=M.document.getPageCount(),l=e<a?lt(e):{width:0,height:0},r=e<a-o?lt(a-1):{width:0,height:0},s=pt(t,e);s.width+=l.width,s.height+=l.height;var c=pt(e+1,a-1);if(c.width+=r.width,c.height+=r.height,E.direction===V.Vertical)if(b.edges[0].height(i.height),e+n>=M.document.getPageCount()){var u=i.height+s.height+c.height;b.scrollH&&u>b.scroller[0].clientHeight&&b.content.width()<=b.scroller[0].clientWidth?b.edges[1].height(b.scrollH.scrollbarHeight()):b.edges[1].height(0)}else b.edges[1].height(c.height),Atalasoft.Utils.Browser.Chrome&&b.content.height("");else if(E.direction===V.Horizontal)if(b.edges[0].width(i.width),e+n>=M.document.getPageCount()){var d=i.width+s.width+c.width;b.scrollV&&d>b.scroller[0].clientWidth&&b.content.height()<=b.scroller[0].clientHeight?b.scrollV._explicitSize?b.edges[1].width(b.scrollV.height()<b.scrollV._tray.height()?b.scrollV.width():0):b.edges[1].width(b.scrollV.width()):b.edges[1].width(0)}else b.edges[1].width(c.width),b.edges[1].height(1)}function Et(){return k.activepage}function Lt(t){if(t=t||1,0===k.prpr&&0<b.pageDivs.length){var e=mt(E.zoom);Qt();for(var o=t;0<o;o--){var n=b.pageDivs[0]._index-e;if(0<=n&&n<M.document.getPageCount()){for(var i=e-1;0<=i;i--){var a=Jt(-1);Nt(a),b.content.prepend(a),jt(a,Gt(n+i),n+i)}St(n,null),kt()}}setTimeout(Xt,10)}}function Ft(t){t=t||1;var e=b.pageDivs[b.pageDivs.length-1]._index+1;if(0===k.prpr&&0<b.pageDivs.length&&e<M.document.getPageCount()){Qt();for(var o=mt(E.zoom),n=M.document.getPageCount(),i=t;0<i;i--){var a=b.pageDivs[b.pageDivs.length-1]._index+1;if(a<n){for(var l=a+o-1-b.pageDivs.length,r=0;r<o;r++){var s=Jt(1);Nt(s),b.content.append(s),jt(s,Gt(a+r),a+r)}St(l+1,a),kt()}}setTimeout(Xt,10)}}
/**
...
/**
    ...
    * @memberOf Atalasoft.Controls.WebDocumentViewer
    * @function zoom
    */function ce(t,e){if(k.zooming)bt("zooming",e);else if(k.zooming=!0,ie(),eo("zoomstarted"),e=null==e?ue:Atalasoft.Utils.__functionFromArray([ue,e]),t!==E.zoom){t=Math.min(t,at()),t=Math.max(t,it());var o=gt(I.number,null,null),n=gt(I.number,null,null,t),i=(b.scroller.scrollLeft()-o.width)/E.zoom*t,a=(b.scroller.scrollTop()-o.height)/E.zoom*t;E.zoom=t,fe(!0,function(){ge(t,!0,function(){e(),Pt(n.width+i,n.height+a,!1,H,function(){b.scrollH.scrollLeft(b.scroller.scrollLeft()),b.scrollV.scrollTop(b.scroller.scrollTop())})})})}else"function"==typeof e&&e.call()}function ue(){k.zooming=!1,ae(),eo({type:"zoomchanged",zoom:E.zoom})}function de(t,e){ce(E.zoom+(t?-1:1)*E.zoom*.3,e)}function he(){b.edges[0]._z=E.zoom}function ge(t,e,o){if(0<b.edges.length){o="function"==typeof o?Atalasoft.Utils.__functionFromArray([he,o]):he;var n=E.direction===V.Vertical,i=gt(b.pageDivs[0]&&b.pageDivs[0]._img?b.pageDivs[0]._index:0,null,null,t),a=n?i.height:i.width;if(e&&!k.loading){var l=n?{height:a}:{width:a};b.edges[0].animate(l,{duration:H,easing:"easeOutQuad",complete:o,queue:!1})}else n?b.edges[0].height(a):b.edges[0].width(a),"function"==typeof o&&o.call();pe()}}function pe(d){setTimeout(function(){var t=C("<canvas/>"),e=C('<span style="position:absolute; visibility:hidden; left: -5000px;">{[|,0123456789Thqkbfjplyg</span>');C(document.body).append(e),d=d||E.zoom;var o=E.direction===V.Vertical,n=k.newpagedivsize?k.newpagedivsize:{width:I.size.width*d,height:I.size.height*d},i=Math.max(1,E.pagespacing),a=mt();t[0].width=(n.width+i)*(o?a:1),t[0].height=n.height*(o?1:a);var l=t[0].getContext("2d");l.lineWidth=E.pageborderwidth,E.backcolor&&(l.fillStyle=E.backcolor);for(var r=0;r<a;++r){var s=o?1+r*n.width:1,c=o?1:1+r*n.height;l.strokeRect(s,c,n.width-2,n.height-2),E.backcolor&&l.fillRect(s+l.lineWidth,c+l.lineWidth,n.width-2*(1+l.lineWidth),n.height-2*(1+l.lineWidth))}var u={backgroundImage:"url("+t[0].toDataURL()+")",backgroundSize:"auto auto",backgroundRepeat:o?"repeat-y":"repeat-x"};b.edges[0].css(u),b.edges[1].css(u),e.remove()},0)}function fe(t,e){for(var o=0,n=!0,i=function(){if(--o<=0){if(E.direction===V.Horizontal){var t=ht().width;b.spacer||(b.spacer=F(),b.spacer.css({position:"absolute",top:"-1px",height:"1px"}),b.viewport.append(b.spacer)),b.spacer.width(t)}"function"==typeof e&&e.call(),0===k.prpr&&(Atalasoft.Utils.Browser.Safari||Atalasoft.Utils.Browser.Chrome?b.edges[1].hide().show():b.edges[1][0].className=b.edges[1][0].className)}},a=0;a<b.pageDivs.length;a++){if(b.pageDivs[a]._img)(b.pageDivs[a]._img.needsZoom()||b.pageDivs[a]._img.needsRotate())&&(n=!1,o++,b.pageDivs[a]._img.needsRotate()?b.pageDivs[a]._img.rotate(i):b.pageDivs[a]._img.needsZoom()&&b.pageDivs[a]._img.zoom(t,i))}n&&i.call()}
/**
    ...
    * @memberOf Atalasoft.Controls.WebDocumentViewer
    * @function fit
    */function me(t,e,o){null!=e?"function"==typeof e&&(o=e,e=I.number):e=I.number;var n=_e(t,e-1),i=n.zoom,a=d.Width===n.fit&&V.Vertical===E.direction,l=d.Height===n.height;a&&Pt(0,null,!1),l&&Pt(null,0,!1),ce(i,o)}function _e(t,e){var o,n,i,a=(o=wt(),n=E.showpageborder?2*E.pageborderwidth:0,i={width:o.width-n,height:o.height-n},E.tabular&&(1<E.columns&&(i.width=Math.floor((o.width-(E.pagespacing+n)*E.columns)/E.columns)),1<E.rows&&(i.height=Math.floor((o.height-(E.pagespacing+n)*E.rows)/E.rows))),i),l=rt(e,1,!1);0!==l.width&&0!==l.height||(t=null);var r=E.zoom;switch(t){case d.None:break;case d.Best:t=l.width/a.width>l.height/a.height?(r=a.width/l.width,d.Width):(r=a.height/l.height,d.Height);break;case d.Height:r=a.height/l.height;break;case d.Width:r=a.width/l.width;break;default:r=1,t=d.None}return{zoom:r,fit:t}}function ve(t){return E.zoom*M.document.getPageFitMultiplier(t)}function we(t){return M.document.getPageRotation(t)}function be(t,e){e=e||0;var o=we(t),n=ve(t),i=_t(t,e),a=Raphael.matrix();a.scale(n,n,0,0),a.rotate(o+e,0,0);var l,r,s=(l=a,r={x:i.width,y:i.height},{x:l.x(r.x,r.y),y:l.y(r.x,r.y)}),c=Math.min(0,s.x),u=Math.min(0,s.y),d=a.invert(),h=d.x(-c,-u),g=d.y(-c,-u);return a.translate(h,g),a}function xe(t){var e=C.data(t.currentTarget,"_config"),o=C.data(t.currentTarget,"_annoConfig");!o&&e&&(o={type:e.icon,rotatable:E.showrotatetools}),o&&(M.mouseTool.setTool(r.None,r.None),M.annotations.drawAnnotation(o,!1,ze,ye))}function ye(t){M.mouseTool.setTool(r.Pan,r.None)}function ze(t){M.mouseTool.setTool(r.Pan,r.None)}
/**
    * Checks whether annotations support is enabled.
    * @private
    */function De(){return!1===E.allowannotations&&L("InitError",'The "allowannotations" property in the WebDocumentViewer config is set to false.'),E.allowannotations}function Te(){for(var t=0;t<b.pageDivs.length;t++)b.pageDivs[t]._draw.toFront()}function Pe(){for(var t=0;t<b.pageDivs.length;t++)b.pageDivs[t]._draw.reset()}function Ce(t,e,o){if(t){if(k.loading=!0,Ot(),I.size.width=t.pagewidth,I.size.height=t.pageheight,I.count=t.pagecount,I.buffer=E.pagebuffersize,I.dpi=t.dpi,I.vector=!0===t.vector,E.allowannotations=o.allowannotations,E.allowforms=o.allowforms,E.allowtext=o.allowtext,E.documenturl=o.documenturl,E.annotationsurl=o.annotationsurl,E.formsurl=o.formsurl,M.document.__linkChanges(e),M.annotations&&(M.annotations.clear(),M.annotations.loadAnnotations(t)),M.forms&&(M.forms.clear(),t.forms&&M.forms.loadForms(t)),M.text&&M.text.search(""),M.mouseTool.setTool(E.mousetool.type&&!A?E.mousetool.type:r.Pan,r.None),k.zooming=!1,t.zoom)E.zoom=t.zoom;else{var n=_e(E.fitting,1);E.zoom=n.zoom}Ie(t.pagenumber||0),pe(),k.loading=!1,fe(),J=e.__getSelectedPagesIndices,eo({type:"activedocumentchanged"})}}function Ae(t,e){e&&qe(!0);for(var o=0;o<t._controllers.document.getPageCount();++o){var n=t._controllers.document.getPageDefinition(o,s);n&&0<=n.cacheIndex&&b.loadedImgs[n.cacheIndex]&&(M.memory.deallocate(b.loadedImgs[n.cacheIndex]),b.loadedImgs[n.cacheIndex].dispose(),b.loadedImgs[n.cacheIndex].remove(),b.loadedImgs[n.cacheIndex]=void 0)}}function He(t,n){k.loading=!0;var e={atala_docurl:E.documenturl,atala_pagebuffer:E.pagebuffersize,atala_minwidth:E.minwidth};A&&(e.atala_thumb=A,e.atala_capt_format=E.thumbcaptionformat),null!=t&&("function"==typeof t&&(n=t,t=null),C.extend(e,t)),Oe({type:"docinfo",serverurl:E.serverurl,query:"?ataladocinfo=",method:"GET",data:e,cancel:!1,info:{pagewidth:-1,pageheight:-1,pagecount:-1}},function(t){Me(t,n)},function(t,e,o){!function(t,e,o,n){if(t.responseText){var i=t.responseText.substr(t.responseText.indexOf("</html>")+7);0<=i.indexOf("\x3c!--")?0<(i=i.replace("\x3c!--","").replace("--\x3e","")).length&&(o="<pre>"+i+"</pre>"):0<t.responseText.indexOf("web.config")&&0<t.responseText.indexOf("customErrors")&&(o+=": web.config customErrors attribute has disabled remote error messages.")}L("DocumentLoadError",o),"function"==typeof n&&n.call(void 0,o)}(t,0,o,n)})}function Me(e,o){if(e&&!1!==e.licensed)I.size.width=e.pagewidth,I.size.height=e.pageheight,I.count=e.pagecount,I.buffer=E.pagebuffersize,I.dpi=e.dpi,I.vector=!0===e.vector,I.caption=e.thumbcaptionformat||(E.showthumbcaption?"{0}":""),dt.zero(),M.memory.clearEntries(),M.memory.colorDepth=e.colordepth,M.memory.pageSize={width:e.pagewidth,height:e.pageheight},eo({type:"documentinfochanged",info:{count:I.count,dpi:I.dpi,size:{height:I.size.height,width:I.size.width},vector:I.vector},customData:e.customData}),M.text&&(M.text.clear(),e.text&&M.text.loadText(e)),k.loading&&(E.zoom=1,G(),Pt(0,0),b.scrollV&&b.scrollV.pageNum(1),Rt(1),me(E.fitting,1,function(){kt(),St(0,b.pageDivs.length-1);for(var t=0;t<b.pageDivs.length&&t<I.count;t++)b.content.append(b.pageDivs[t]),jt(b.pageDivs[t],null,t);0<b.pageDivs.length&&b.pageDivs[0].addClass(S.atala_active_page),e.layers&&e.layers.length?M.annotations.loadAnnotations(e):E.annotationsurl&&M.annotations&&M.annotations.clear(),M.forms&&(M.forms.clear(),e.forms&&M.forms.loadForms(e)),M.mouseTool.setTool(E.mousetool.type&&!A?E.mousetool.type:r.Pan,r.None),k.loading=!1,pe(),"function"==typeof o&&o(e.error,e),e.error&&setTimeout(function(){L("DocumentLoadError",e.error)},0)})),k.loading=!1;else{var t=void 0,n=void 0;n=e&&!1===e.licensed?(t="LicenseException",e.error?e.error:"LicenseException: Handler was unable to find a valid license."):(t="DocumentLoadError","HandlerException: Handler did not return any data."),k.loading=!1,"function"==typeof o&&o.call(void 0,n),t&&n&&L(t,n)}}function Ve(t){Ie()}function Ie(t){if(G(),0<b.pageDivs.length){var e=M.document.getPageCount(),o="number"==typeof t?t:b.pageDivs[0]._index;o=0<=o?Math.min(o,e-b.pageDivs.length):0;for(var n=0;n<b.pageDivs.length&&n<e;n++){var i=o+n;Nt(b.pageDivs[n]),b.content.append(b.pageDivs[n]),jt(b.pageDivs[n],null,i)}}St(0<b.pageDivs.length?b.pageDivs[0]._index:0,null),kt(),Fe(),At();var a=ct(b.scroller[0].scrollLeft,b.scroller[0].scrollTop);Rt(a+1),0<=t&&a!==t&&Ut(t)}function ke(t,e){var o={atala_docurl:E.documenturl,atala_spath:E.savepath};function n(t){!function(t){t.error?L("DocumentSaveError",t.error):zt("DocumentSave: success="+t.success);eo({type:"documentsaved",success:t.success,customData:t.customData,fileName:t.fileName})}(t),"function"==typeof e&&e.call()}C.extend(o,t),Oe({type:"docsave",serverurl:E.serverurl,query:"?ataladocsave=",method:"POST",data:o,cancel:!1,info:{success:void 0,error:void 0}},n,function(t){var e=[];e.error=t.responseText,n(e)})}function Se(t,e,o){var n=null;return"string"==typeof t?(n={},k.initialized&&o&&(0<t.length?n=o.createHandlerRequest(E.serverurl,t,e):0===t.length&&o.clear()),n.url=t):void 0!==t&&null!=t&&L("openUrlError","string input expected for url."),n}function Ee(){Ye({annotationsloaded:We})}function Le(){Ye({formsloaded:Re})}function Fe(t){if(!(0<b.pageDivs.length&&void 0===b.pageDivs[0]._index))for(var e=0;e<b.pageDivs.length;e++)Be(b.pageDivs[e],t)}function Ue(t,e){var o=Yt(t);o&&Be(o,e)}function Be(t,e){(jt(t,Gt(t._index),t._index)||e)&&(M.annotations&&M.annotations.showLayer(t._index,t),M.forms&&!A&&M.forms.showLayer(t._index,t),M.text&&!A&&E.allowtext&&M.text.showLayer(t._index,t))}function We(t){t.error&&(L("AnnotationsLoadError",t.error),E.annotationsurl=""),M.annotations&&to({annotationsloaded:We})}function Re(t){t.error&&(L("FormsLoadError",t.error),E.formsurl=""),M.forms&&to({formsloaded:Re})}function Oe(n,e,i,o){var a,l,t,r=(a=n,l=function(t){e(t.request.info)},Ye({handlerreturned:t=function t(e){e.request===a&&(to({handlerreturned:t}),"function"==typeof l&&l.call(this,e))}}),t);if(eo({type:"beforehandlerrequest",request:n}),!n.cancel&&(to({handlerreturned:r}),n.serverurl&&!C.isEmptyObject(n.data))){if(!(n.info instanceof jQuery&&"docpage"===n.type)){if("fileupload"!==n.type)return C.ajax({type:n.method,url:n.serverurl+n.query+"?",dataType:"json",data:n.data,success:e,error:i,crossDomain:("string"!=typeof n.method||"post"!==n.method.toLowerCase())&&void 0});var s="&"+C.param(n.data),c=new FormData;c.append("file",n.file,n.file.name);var u=C.ajax({type:n.method,url:n.serverurl+n.query+"??"+s,dataType:"json",data:c,contentType:!1,processData:!1,success:function(t){t.success&&(t.success=JSON.parse(t.success)),t.canceled&&(t.canceled=JSON.parse(t.canceled)),e(t,n.file.name)},error:function(t,e,o){i(e,o,n.file.name)},crossDomain:("string"!=typeof n.method||"post"!==n.method.toLowerCase())&&void 0,xhr:function(){var t=new XMLHttpRequest;return t.upload.addEventListener("progress",function(t){t.lengthComputable&&(o(n.file.name,t.loaded,t.total)||u.abort())},!1),t}});return u}n.info.attr("src",n.serverurl+n.query+"&"+C.param(n.data))}}
/**
     ...
     * @function empty
    */
function Ne(t){k.loading=!0;qe(),Me({pagewidth:0,pageheight:0,pagecount:-1},function(){At(),eo({type:"documentunloaded"}),"function"==typeof t&&t.call()})}function qe(t){var e;k.initialized&&(Ot(),G(0),t||function(){for(var t=0;t<b.loadedImgs.length;t++)b.loadedImgs[t]&&(b.loadedImgs[t].dispose(),b.loadedImgs[t].remove());b.loadedImgs.length=0}(),b.edges[0].width(0).height(0),b.edges[1].width(0).height(0),b.scrollH&&(b.scrollH.scrollSize(0),Mt(b.scrollH)),b.scrollV&&(b.scrollV.scrollSize(0),Mt(b.scrollV)),e={backgroundImage:"",backgroundSize:"",backgroundRepeat:"",backgroundColor:""},b.edges[0].css(e),b.edges[1].css(e))}
/**
...
/**
    ...
    * @function next
    */
function Ze(t,e){var o=E.direction===V.Vertical?mt():1;null==e&&"function"==typeof t&&(e=t,t=o),isFinite(t)||(t=o),Ct(t,e)}
/**
    ...
    * @memberOf Atalasoft.Controls.WebDocumentViewer
    * @function previous
    */function Qe(t,e){var o=E.direction===V.Vertical?mt():1;null==e&&"function"==typeof t&&(e=t,t=o),isFinite(t)||(t=o),Ct(-t,e)}
/**
     * Zooms in one level.
...
/**
    ...
    * @function save
     ...
     * _viewer.save(‘’, ‘tif’)
     */function Ge(t,e,o,n){"function"==typeof o&&(n=o,o={}),"function"==typeof e&&(n=e,e=E.savefileformat),"function"==typeof t&&(n=t,t=null),void 0===e&&(e=E.savefileformat);var i=C.extend(!0,o,{atala_subpath:t||"",atala_sformat:e});M.annotations&&C.extend(i,{atala_iuname:E.annotations.saveusername,atala_annos:M.annotations.stringifyChanges()}),M.forms&&C.extend(i,{atala_forms:M.forms.stringifyChanges()}),M.document&&C.extend(i,{atala_document:M.document.stringifyChanges()}),ke(i,n)}
/**
...
/**
    ...
    */
return c.__getDebugInfo=function(){var t={version:Atalasoft.Controls.Version.join(".")};E.debug&&C.extend(!0,t,{dom:b,controllers:M,page:I});return t}
/**
...
/**
     ...
     *
     */
function(t,e,o){if(A)return;M.upload.uploadFiles(t,e,o)}
/**
     ...
     */,c.uploadFile=function(t,e,o){if(A)return;M.upload.uploadFile(t,e,o)}
/**
     ...
     */,c.filterFilesForUpload=function(t,e,o){if(A)return;return M.upload.filterFilesPublic(t,e,o)},c.getCurrentPageIndex=Ke,c.bind=Ye,c.unbind=to,c.trigger=eo,c.getDocumentInfo=function(){return{count:M.document.getPageCount(),dpi:I.dpi,size:{height:I.size.height,width:I.size.width},vector:I.vector}},c.setMouseTool=function(t){for(var e in Atalasoft.Utils.MouseToolType)if(Atalasoft.Utils.MouseToolType.hasOwnProperty(e)&&Atalasoft.Utils.MouseToolType[e]===t){M.mouseTool.setTool(t);break}},c.isPageLoaded=function(t){var e=M.document.getPageDefinition(t);return 0<=e.cacheIndex&&b.loadedImgs[e.cacheIndex]&&b.loadedImgs[e.cacheIndex]._loaded}
/**
